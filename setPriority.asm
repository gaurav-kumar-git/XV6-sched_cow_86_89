  ...
  13:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  4e:	56                   	push   %esi
  4f:	50                   	push   %eax
  50:	e8 3e 03 00 00       	call   393 <set_priority>
  ...
  5b:	74 18                	je     75 <main+0x75>
    ...
    exit();
  5d:	e8 81 02 00 00       	call   2e3 <exit>
        printf(2, "Invalid priority given. Try again\n");
  62:	51                   	push   %ecx
  63:	51                   	push   %ecx
...
000002fb <getprocstable>:
SYSCALL(getprocstable)
 2fb:	b8 18 00 00 00       	mov    $0x18,%eax
 300:	cd 40                	int    $0x40
 302:	c3                   	ret    
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 d8 07 00 00 	jmp    *0x7d8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba cf 07 00 00       	mov    $0x7cf,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f1:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 e0 0a 00 00    	mov    %edx,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
 ...
 72c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 72f:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf e4 0a 00 00       	mov    $0xae4,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 762:	00 00 00 
    if(p->s.size >= nunits){
