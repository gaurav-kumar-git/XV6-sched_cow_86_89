...
int main(int argc, char *argv[]) {
  ...
  15:	8b 71 04             	mov    0x4(%ecx),%esi
    ...
    int a = fork();
  18:	e8 ce 02 00 00       	call   2eb <fork>
    if(argc!=1){
  ...
  29:	6a 04                	push   $0x4
  2b:	e8 60 06 00 00       	call   690 <malloc>
  30:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  37:	89 c6                	mov    %eax,%esi
  39:	e8 52 06 00 00       	call   690 <malloc>
  ...
  42:	53                   	push   %ebx
  43:	56                   	push   %esi
  44:	e8 ba 02 00 00       	call   303 <waitx>
  ...
  5c:	83 c4 20             	add    $0x20,%esp
    ...
    exit();
  5f:	e8 8f 02 00 00       	call   2f3 <exit>
            if(exec(argv[1], argv + 1)<0){
  64:	8d 46 04             	lea    0x4(%esi),%eax
  67:	53                   	push   %ebx
  68:	53                   	push   %ebx
  69:	50                   	push   %eax
  6a:	ff 76 04             	push   0x4(%esi)
  6d:	e8 c9 02 00 00       	call   33b <exec>
 ...
 1c9:	31 db                	xor    %ebx,%ebx
{
 ...
 1d5:	57                   	push   %edi
 1d6:	6a 00                	push   $0x0
 1d8:	e8 3e 01 00 00       	call   31b <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 23d:	e8 01 01 00 00       	call   343 <open>
  if(fd < 0)
 ...
 251:	50                   	push   %eax
 252:	e8 04 01 00 00       	call   35b <fstat>
  close(fd);
 257:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 25a:	89 c6                	mov    %eax,%esi
  close(fd);
 25c:	e8 ca 00 00 00       	call   32b <close>
  return r;
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba c6 07 00 00       	mov    $0x7c6,%edx
        while(*s != 0){
