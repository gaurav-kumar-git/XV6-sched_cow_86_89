     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 a9 2e 00 00       	call   390b <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 7e 2e 00 00       	call   38fb <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 2f 2e 00 00       	call   390b <close>
     ...
     b11:	e8 ed 2d 00 00       	call   3903 <write>
    ...
    close(fds[0]);
     ...
     b3c:	e8 ca 2d 00 00       	call   390b <close>
    wait();
...
00000bb0 <preempt>:
{
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 f7 2c 00 00       	call   38f3 <pipe>
  pid3 = fork();
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 cd 2c 00 00       	call   390b <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 90 2c 00 00       	call   390b <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 82 2c 00 00       	call   3913 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 7a 2c 00 00       	call   3913 <kill>
  kill(pid3);
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 b8 2b 00 00       	call   3963 <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    exit();
     ...
     e3a:	e8 d4 2a 00 00       	call   3913 <kill>
      exit();
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 b2 2a 00 00       	call   3933 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 a3 41 00 00       	push   $0x41a3
     e8d:	e8 91 2a 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 22 2a 00 00       	call   3903 <write>
  ...
  close(fd);
     ...
     f14:	e8 f2 29 00 00       	call   390b <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 a3 41 00 00       	push   $0x41a3
     f22:	e8 fc 29 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 aa 29 00 00       	call   38fb <read>
  ...
  close(fd);
     ...
     f86:	e8 80 29 00 00       	call   390b <close>
  unlink("sharedfd");
     f8b:	c7 04 24 a3 41 00 00 	movl   $0x41a3,(%esp)
     f92:	e8 9c 29 00 00       	call   3933 <unlink>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 cf 28 00 00       	call   3933 <unlink>
    pid = fork();
  ...
  for(i = 0; i < 2; i++){
    ...
    fd = open(fname, 0);
    10ad:	e8 71 28 00 00       	call   3923 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 26 28 00 00       	call   38fb <read>
    ...
    1104:	e8 02 28 00 00       	call   390b <close>
    if(total != 12*500){
    ...
    111e:	e8 10 28 00 00       	call   3933 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    116b:	56                   	push   %esi
    116c:	e8 b2 27 00 00       	call   3923 <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 58 27 00 00       	call   3903 <write>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 75 26 00 00       	call   3923 <open>
      if((i == 0 || i >= N/2) && fd < 0){
  ...
  printf(1, "createdelete ok\n");
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 84 25 00 00       	call   3923 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 5c 25 00 00       	call   390b <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 65 25 00 00       	call   3933 <unlink>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 be 24 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 81 24 00 00       	call   3903 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 81 24 00 00       	call   390b <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 55 42 00 00       	push   $0x4255
    1493:	e8 8b 24 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 81 24 00 00       	call   3933 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 54 24 00 00       	call   3923 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 e2 23 00 00       	call   3903 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 d9 23 00 00       	call   390b <close>
  unlink("unlinkread");
    1532:	c7 04 24 55 42 00 00 	movl   $0x4255,(%esp)
    1539:	e8 f5 23 00 00       	call   3933 <unlink>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 da 22 00 00       	call   3903 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 cd 22 00 00       	call   390b <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 1a 43 00 00       	push   $0x431a
    1645:	68 16 43 00 00       	push   $0x4316
    164a:	e8 f4 22 00 00       	call   3943 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 cc 22 00 00       	call   3933 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 16 43 00 00       	push   $0x4316
    1670:	e8 ae 22 00 00       	call   3923 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 94 22 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 4c 22 00 00       	call   38fb <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 47 22 00 00       	call   390b <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 1a 43 00 00       	push   $0x431a
    16cb:	68 1a 43 00 00       	push   $0x431a
    16d0:	e8 6e 22 00 00       	call   3943 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 46 22 00 00       	call   3933 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 16 43 00 00       	push   $0x4316
    16f4:	68 1a 43 00 00       	push   $0x431a
    16f9:	e8 45 22 00 00       	call   3943 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 2c 22 00 00       	call   3943 <link>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 f4 20 00 00       	call   3923 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 c9 20 00 00       	call   390b <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 d1 20 00 00       	call   3933 <unlink>
    pid = fork();
    ...
    1884:	53                   	push   %ebx
    1885:	e8 99 20 00 00       	call   3923 <open>
      if(fd < 0){
    ...
    18b9:	e8 85 20 00 00       	call   3943 <link>
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 62 20 00 00       	call   3943 <link>
  ...
  fd = open(".", 0);
    ...
    190e:	e8 10 20 00 00       	call   3923 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 cf 1f 00 00       	call   38fb <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 92 1f 00 00       	call   390b <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    19ad:	e8 81 1f 00 00       	call   3933 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 79 1f 00 00       	call   3933 <unlink>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 13 1f 00 00       	call   3923 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 f3 1e 00 00       	call   390b <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 01 1f 00 00       	call   3923 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 e1 1e 00 00       	call   390b <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 ef 1e 00 00       	call   3923 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 cf 1e 00 00       	call   390b <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 dd 1e 00 00       	call   3923 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 bd 1e 00 00       	call   390b <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1ad1:	50                   	push   %eax
    1ad2:	e8 34 1e 00 00       	call   390b <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 32 1e 00 00       	call   3933 <unlink>
  pid = fork();
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 f1 1d 00 00       	call   3933 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 a8 1d 00 00       	call   3923 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 88 1d 00 00       	call   390b <close>
  ...
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 81 1d 00 00       	call   3943 <link>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 22 1d 00 00       	call   3933 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 65 44 00 00       	push   $0x4465
    1c1d:	e8 01 1d 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 d0 1c 00 00       	call   390b <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 d7 1c 00 00       	call   3943 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 a6 1c 00 00       	call   3933 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 7c 1c 00 00       	call   3933 <unlink>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 f4 1b 00 00       	call   3933 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 d8 45 00 00 	movl   $0x45d8,(%esp)
    1d46:	e8 00 1c 00 00       	call   394b <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 bb 1b 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 7e 1b 00 00       	call   3903 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 7e 1b 00 00       	call   390b <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 d8 45 00 00 	movl   $0x45d8,(%esp)
    1d94:	e8 9a 1b 00 00       	call   3933 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 9a 1b 00 00       	call   394b <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 55 1b 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 18 1b 00 00       	call   3903 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 18 1b 00 00       	call   390b <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 32 45 00 00       	push   $0x4532
    1dfc:	e8 22 1b 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 da 1a 00 00       	call   38fb <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 c8 1a 00 00       	call   390b <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 72 45 00 00       	push   $0x4572
    1e4a:	68 0e 45 00 00       	push   $0x450e
    1e4f:	e8 ef 1a 00 00       	call   3943 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 c7 1a 00 00       	call   3933 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 9d 1a 00 00       	call   3923 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 b5 1a 00 00       	call   3953 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 9d 1a 00 00       	call   3953 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 85 1a 00 00       	call   3953 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 6d 1a 00 00       	call   3953 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 23 1a 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 db 19 00 00       	call   38fb <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 d6 19 00 00       	call   390b <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 0e 45 00 00       	push   $0x450e
    1f3e:	e8 e0 19 00 00       	call   3923 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 c3 19 00 00       	call   3923 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 a6 19 00 00       	call   3923 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 89 19 00 00       	call   3923 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 6f 19 00 00       	call   3923 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 55 19 00 00       	call   3923 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 58 19 00 00       	call   3943 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 3b 19 00 00       	call   3943 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 1e 19 00 00       	call   3943 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 0e 19 00 00       	call   394b <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 f6 18 00 00       	call   394b <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 de 18 00 00       	call   394b <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 ae 18 00 00       	call   3933 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 96 18 00 00       	call   3933 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 9e 18 00 00       	call   3953 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 86 18 00 00       	call   3953 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 4e 18 00 00       	call   3933 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 36 18 00 00       	call   3933 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 1e 18 00 00       	call   3933 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 06 18 00 00       	call   3933 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 ee 17 00 00       	call   3933 <unlink>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 0e 15 00 00       	call   3933 <unlink>
    ...
    243d:	e8 e1 14 00 00       	call   3923 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 a9 14 00 00       	call   3903 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 93 14 00 00       	call   3903 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 85 14 00 00       	call   390b <close>
    unlink("bigwrite");
    2486:	c7 04 24 d4 47 00 00 	movl   $0x47d4,(%esp)
    248d:	e8 a1 14 00 00       	call   3933 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 32 14 00 00       	call   3933 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 30 48 00 00       	push   $0x4830
    250d:	e8 11 14 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 b5 13 00 00       	call   3903 <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 9e 13 00 00       	call   390b <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 30 48 00 00       	push   $0x4830
    2576:	e8 a8 13 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 2a 13 00 00       	call   38fb <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 28 13 00 00       	call   390b <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 34 13 00 00       	call   3933 <unlink>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 7d 12 00 00       	call   394b <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 65 12 00 00       	call   394b <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 20 12 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 f4 11 00 00       	call   390b <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 88 51 00 00       	push   $0x5188
    2720:	e8 fe 11 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 d6 11 00 00       	call   390b <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 fc 48 00 00 	movl   $0x48fc,(%esp)
    273c:	e8 0a 12 00 00       	call   394b <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 f6 11 00 00       	call   394b <mkdir>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 3d 11 00 00       	call   394b <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 2d 11 00 00       	call   3953 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 f5 10 00 00       	call   3933 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 dd 10 00 00       	call   3933 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 e5 10 00 00       	call   3953 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 ad 10 00 00       	call   3933 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 99 10 00 00       	call   3933 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 85 10 00 00       	call   3933 <unlink>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 8f 0f 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 63 0f 00 00       	call   390b <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 e5 49 00 00 	movl   $0x49e5,(%esp)
    29af:	e8 9f 0f 00 00       	call   3953 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 55 0f 00 00       	call   3923 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 38 0f 00 00       	call   3923 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 48 0f 00 00       	call   394b <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 18 0f 00 00       	call   3933 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 0b 0f 00 00       	call   3943 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 e3 0e 00 00       	call   3933 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 b9 0e 00 00       	call   3923 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 9f 0e 00 00       	call   3923 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 6d 0e 00 00       	call   3903 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 65 0e 00 00       	call   390b <close>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 ae 0d 00 00       	call   394b <mkdir>
    ...
    2bb0:	e8 9e 0d 00 00       	call   3953 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 e7 0c 00 00       	call   390b <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 c0 46 00 00       	push   $0x46c0
    2c2f:	e8 ff 0c 00 00       	call   3933 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 06 0d 00 00       	call   3953 <chdir>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d62:	e8 04 0c 00 00       	call   396b <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 f5 0b 00 00       	call   396b <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 df 0b 00 00       	call   396b <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 a7 0b 00 00       	call   396b <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 9b 0b 00 00       	call   396b <sbrk>
  if(c != a + 1){
  ...
  a = sbrk(0);
    ...
    2deb:	6a 00                	push   $0x0
    2ded:	e8 79 0b 00 00       	call   396b <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 68 0b 00 00       	call   396b <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2e18:	6a 00                	push   $0x0
    2e1a:	e8 4c 0b 00 00       	call   396b <sbrk>
  c = sbrk(-4096);
    2e1f:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e26:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e28:	e8 3e 0b 00 00       	call   396b <sbrk>
  ...
  c = sbrk(0);
    ...
    2e3c:	6a 00                	push   $0x0
    2e3e:	e8 28 0b 00 00       	call   396b <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e57:	6a 00                	push   $0x0
    2e59:	e8 0d 0b 00 00       	call   396b <sbrk>
  c = sbrk(4096);
    2e5e:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e65:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e67:	e8 ff 0a 00 00       	call   396b <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e7c:	6a 00                	push   $0x0
    2e7e:	e8 e8 0a 00 00       	call   396b <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2edf:	90                   	nop
    ppid = getpid();
    2ee0:	e8 7e 0a 00 00       	call   3963 <getpid>
  ...
  if(pipe(fds) != 0){
    ...
    2f13:	50                   	push   %eax
    2f14:	e8 da 09 00 00       	call   38f3 <pipe>
    ...
    2f50:	e8 a6 09 00 00       	call   38fb <read>
  ...
  c = sbrk(4096);
    ...
    2f67:	e8 ff 09 00 00       	call   396b <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f82:	50                   	push   %eax
    2f83:	e8 8b 09 00 00       	call   3913 <kill>
    wait();
  ...
  if(sbrk(0) > oldbrk)
    ...
    2fa3:	6a 00                	push   $0x0
    2fa5:	e8 c1 09 00 00       	call   396b <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3081:	e8 8d 08 00 00       	call   3913 <kill>
      exit();
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 ae 07 00 00       	call   3973 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 a2 07 00 00       	call   3973 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 3a 07 00 00       	call   3913 <kill>
    wait();
    ...
    31e6:	e8 58 07 00 00       	call   3943 <link>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 73 06 00 00       	call   3933 <unlink>
  pid = fork();
  ...
  fd = open("bigarg-ok", 0);
    ...
    32e1:	e8 3d 06 00 00       	call   3923 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 11 06 00 00       	call   390b <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 76 4c 00 00 	movl   $0x4c76,(%esp)
    3301:	e8 2d 06 00 00       	call   3933 <unlink>
}
    ...
    334b:	e8 cb 05 00 00       	call   391b <exec>
    ...
    336e:	e8 b0 05 00 00       	call   3923 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 90 05 00 00       	call   390b <close>
    exit();
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 c5 04 00 00       	call   3923 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 7e 04 00 00       	call   3903 <write>
      if(cc < 512)
    ...
    34a2:	e8 64 04 00 00       	call   390b <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 e2 03 00 00       	call   3933 <unlink>
  while(nfiles >= 0){
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 20 03 00 00       	call   3923 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 55 03 00 00       	call   396b <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 d6 02 00 00       	call   38fb <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 de 02 00 00       	call   390b <close>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 3e 01 00 00       	call   38fb <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 01 01 00 00       	call   3923 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 04 01 00 00       	call   393b <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 ca 00 00 00       	call   390b <close>
  return r;
...
000038e3 <waitx>:
SYSCALL(waitx)
    38e3:	b8 16 00 00 00       	mov    $0x16,%eax
    38e8:	cd 40                	int    $0x40
    38ea:	c3                   	ret    

000038eb <getprocstable>:
SYSCALL(getprocstable)
    38eb:	b8 18 00 00 00       	mov    $0x18,%eax
    38f0:	cd 40                	int    $0x40
    38f2:	c3                   	ret    
    ...
    399c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a0e:	56                   	push   %esi
    3a0f:	57                   	push   %edi
    3a10:	e8 ee fe ff ff       	call   3903 <write>
  while(--i >= 0)
    ...
    3a49:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3a85:	57                   	push   %edi
    3a86:	56                   	push   %esi
    3a87:	e8 77 fe ff ff       	call   3903 <write>
  ...
  write(fd, &c, 1);
    ...
    3ade:	e8 20 fe ff ff       	call   3903 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    3b9f:	e8 5f fd ff ff       	call   3903 <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3cd3:	e8 93 fc ff ff       	call   396b <sbrk>
  if(p == (char*)-1)
