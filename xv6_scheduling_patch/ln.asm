   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  32:	e8 ec 02 00 00       	call   323 <link>
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 3e 01 00 00       	call   2db <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 01 01 00 00       	call   303 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 04 01 00 00       	call   31b <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 ca 00 00 00       	call   2eb <close>
  return r;
