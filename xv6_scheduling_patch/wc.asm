...
main(int argc, char *argv[])
{
  ...
  59:	e8 ad 03 00 00       	call   40b <close>
  for(i = 1; i < argc; i++){
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 26 03 00 00       	call   3fb <read>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 3e 01 00 00       	call   3fb <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 01 01 00 00       	call   423 <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 04 01 00 00       	call   43b <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 ca 00 00 00       	call   40b <close>
  return r;
