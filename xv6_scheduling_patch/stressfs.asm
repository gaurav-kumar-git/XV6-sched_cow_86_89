  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  a2:	50                   	push   %eax
  a3:	e8 3b 03 00 00       	call   3e3 <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 04 03 00 00       	call   3c3 <write>
  for(i = 0; i < 20; i++)
  ...
  ca:	57                   	push   %edi
  cb:	e8 fb 02 00 00       	call   3cb <close>
  ...
  ed:	50                   	push   %eax
  ee:	e8 f0 02 00 00       	call   3e3 <open>
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 3e 01 00 00       	call   3bb <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 01 01 00 00       	call   3e3 <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 04 01 00 00       	call   3fb <fstat>
  close(fd);
 2f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2fa:	89 c6                	mov    %eax,%esi
  close(fd);
 2fc:	e8 ca 00 00 00       	call   3cb <close>
  return r;
