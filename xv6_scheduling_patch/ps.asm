...
int main(void)
{
   ...
   f:	53                   	push   %ebx
  10:	51                   	push   %ecx
  11:	81 ec 0c 0c 00 00    	sub    $0xc0c,%esp
  		[SLEEPING]  "SLEEPING",
  		[RUNNABLE]  "RUNNABLE",
  		[RUNNING]   "RUNNING ",
  		[ZOMBIE]    "ZOMBIE  "
  ...
  21:	6a 01                	push   $0x1
  23:	e8 c8 04 00 00       	call   4f0 <printf>
        #ifdef PBS
        printf(1, "%s ","Priority");
        #endif
        printf(1, "%s ","STATE");
  28:	83 c4 0c             	add    $0xc,%esp
  2b:	68 20 08 00 00       	push   $0x820
  30:	68 1c 08 00 00       	push   $0x81c
  35:	6a 01                	push   $0x1
  37:	e8 b4 04 00 00       	call   4f0 <printf>
        printf(1, "%s ", "r-time");
  3c:	83 c4 0c             	add    $0xc,%esp
  3f:	68 26 08 00 00       	push   $0x826
  44:	68 1c 08 00 00       	push   $0x81c
  49:	6a 01                	push   $0x1
  4b:	e8 a0 04 00 00       	call   4f0 <printf>
        printf(1, "%s " ,"w-time");
  50:	83 c4 0c             	add    $0xc,%esp
  53:	68 2d 08 00 00       	push   $0x82d
  ...
  b0:	83 c3 30             	add    $0x30,%ebx
		printf(1, "%d " ,InfoTable[i].pid);
  b3:	68 3c 08 00 00       	push   $0x83c
  b8:	6a 01                	push   $0x1
  ba:	e8 31 04 00 00       	call   4f0 <printf>
        #ifdef PBS
        printf(1, "%d " ,InfoTable[i].priority);
        #endif
        printf(1, "%s ",states[InfoTable[i].state]);
  bf:	8b 43 d4             	mov    -0x2c(%ebx),%eax
  c2:	83 c4 0c             	add    $0xc,%esp
  c5:	ff 34 85 78 08 00 00 	push   0x878(,%eax,4)
  cc:	68 1c 08 00 00       	push   $0x81c
  d1:	6a 01                	push   $0x1
  d3:	e8 18 04 00 00       	call   4f0 <printf>
        printf(1, "%d " ,InfoTable[i].rtime);
  d8:	83 c4 0c             	add    $0xc,%esp
  db:	ff 73 d8             	push   -0x28(%ebx)
  de:	68 3c 08 00 00       	push   $0x83c
  e3:	6a 01                	push   $0x1
  e5:	e8 06 04 00 00       	call   4f0 <printf>
        printf(1, "%d " ,InfoTable[i].wtime);
  ea:	83 c4 0c             	add    $0xc,%esp
  ed:	ff 73 e8             	push   -0x18(%ebx)
  f0:	68 3c 08 00 00       	push   $0x83c
  f5:	6a 01                	push   $0x1
  f7:	e8 f4 03 00 00       	call   4f0 <printf>
        printf(1, "%d " ,InfoTable[i].n_run);
  fc:	83 c4 0c             	add    $0xc,%esp
  ff:	ff 73 e4             	push   -0x1c(%ebx)
 102:	68 3c 08 00 00       	push   $0x83c
 107:	6a 01                	push   $0x1
 109:	e8 e2 03 00 00       	call   4f0 <printf>
 ...
 10e:	58                   	pop    %eax
 10f:	5a                   	pop    %edx
 110:	68 3a 08 00 00       	push   $0x83a
 115:	6a 01                	push   $0x1
 117:	e8 d4 03 00 00       	call   4f0 <printf>
	for (int i = 0; i < numbers; i++)
 11c:	83 c4 10             	add    $0x10,%esp
 11f:	39 f7                	cmp    %esi,%edi
 121:	75 85                	jne    a8 <main+0xa8>
	}
	exit();
 123:	e8 5b 02 00 00       	call   383 <exit>
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 f0 08 00 00 	movzbl 0x8f0(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 98 08 00 00 	jmp    *0x898(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 90 08 00 00       	mov    $0x890,%edx
        while(*s != 0){
 ...
 691:	a1 a4 0b 00 00       	mov    0xba4,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 a4 0b 00 00    	mov    %edx,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 ...
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf a8 0b 00 00       	mov    $0xba8,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 802:	00 00 00 
    if(p->s.size >= nunits){
