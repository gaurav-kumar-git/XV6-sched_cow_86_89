...
80100028:	bc f0 72 11 80       	mov    $0x801172f0,%esp
...
80100abc:	e8 cf 2f 00 00       	call   80103a90 <myproc>
...
80100ba3:	e8 78 66 00 00       	call   80107220 <allocuvm>
...
80100bd9:	e8 52 65 00 00       	call   80107130 <loaduvm>
...
80100c62:	e8 b9 65 00 00       	call   80107220 <allocuvm>
...
80100dcd:	e8 ce 61 00 00       	call   80106fa0 <switchuvm>
  freevm(oldpgdir);
...
80101da4:	0f 84 64 01 00 00    	je     80101f0e <namex+0x17e>
    ...
    ip = idup(myproc()->cwd);
80101daa:	e8 e1 1c 00 00       	call   80103a90 <myproc>
  acquire(&icache.lock);
...
80102088:	68 ea 7e 10 80       	push   $0x80107eea
...
801024d2:	81 fb f0 72 11 80    	cmp    $0x801172f0,%ebx
...
8010272b:	0f b6 91 00 7b 10 80 	movzbl -0x7fef8500(%ecx),%edx
  shift ^= togglecode[data];
80102732:	0f b6 81 00 7a 10 80 	movzbl -0x7fef8600(%ecx),%eax
  shift |= shiftcode[data];
...
80102748:	83 e2 08             	and    $0x8,%edx
  c = charcode[shift & (CTL | SHIFT)][data];
8010274b:	8b 04 85 e0 79 10 80 	mov    -0x7fef8620(,%eax,4),%eax
...
80102785:	0f 44 c8             	cmove  %eax,%ecx
    shift &= ~(shiftcode[data] | E0ESC);
80102788:	0f b6 81 00 7b 10 80 	movzbl -0x7fef8500(%ecx),%eax
...
80102cca:	68 00 7c 10 80       	push   $0x80107c00
...
80102f27:	68 04 7c 10 80       	push   $0x80107c04
...
80102fe1:	68 13 7c 10 80       	push   $0x80107c13
80102fe6:	e8 95 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102feb:	83 ec 0c             	sub    $0xc,%esp
80102fee:	68 29 7c 10 80       	push   $0x80107c29
...
80103007:	e8 64 0a 00 00       	call   80103a70 <cpuid>
8010300c:	89 c3                	mov    %eax,%ebx
8010300e:	e8 5d 0a 00 00       	call   80103a70 <cpuid>
80103013:	83 ec 04             	sub    $0x4,%esp
80103016:	53                   	push   %ebx
80103017:	50                   	push   %eax
80103018:	68 44 7c 10 80       	push   $0x80107c44
8010301d:	e8 7e d6 ff ff       	call   801006a0 <cprintf>
  idtinit();       // load idt register
80103022:	e8 99 2e 00 00       	call   80105ec0 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80103027:	e8 e4 09 00 00       	call   80103a10 <mycpu>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 45 3f 00 00       	call   80106f90 <switchkvm>
  seginit();
...
80103077:	68 f0 72 11 80       	push   $0x801172f0
8010307c:	e8 8f f5 ff ff       	call   80102610 <kinit1>
  kvmalloc();      // kernel page table
80103081:	e8 fa 43 00 00       	call   80107480 <kvmalloc>
...
801030a4:	e8 e7 30 00 00       	call   80106190 <uartinit>
  pinit();         // process table
801030a9:	e8 42 09 00 00       	call   801039f0 <pinit>
  tvinit();        // trap vectors
...
80103119:	e8 f2 08 00 00       	call   80103a10 <mycpu>
...
80103182:	e8 39 09 00 00       	call   80103ac0 <userinit>
...
801031be:	68 58 7c 10 80       	push   $0x80107c58
...
80103276:	68 5d 7c 10 80       	push   $0x80107c5d
...
80103393:	68 62 7c 10 80       	push   $0x80107c62
...
801033c2:	68 58 7c 10 80       	push   $0x80107c58
...
801033f8:	68 7c 7c 10 80       	push   $0x80107c7c
...
801034a0:	00 00 00 
  initlock(&p->lock, "pipe");
801034a3:	68 9b 7c 10 80       	push   $0x80107c9b
...
80103621:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->readopen == 0 || myproc()->killed){
80103628:	e8 63 04 00 00       	call   80103a90 <myproc>
...
801036fe:	66 90                	xchg   %ax,%ax
    if(myproc()->killed){
80103700:	e8 8b 03 00 00       	call   80103a90 <myproc>
...
801037cf:	90                   	nop
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801037d0:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
801037d6:	81 fb 74 5a 11 80    	cmp    $0x80115a74,%ebx
801037dc:	0f 84 fe 00 00 00    	je     801038e0 <allocproc+0x130>
    if (p->state == UNUSED)
...
80103805:	89 43 10             	mov    %eax,0x10(%ebx)
  p->ctime = ticks;
80103808:	a1 80 5a 11 80       	mov    0x80115a80,%eax
  p->etime = 0;
8010380d:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103814:	00 00 00 
  p->ctime = ticks;
80103817:	89 43 7c             	mov    %eax,0x7c(%ebx)
  p->lastWorkingticks = ticks;
8010381a:	89 83 b0 00 00 00    	mov    %eax,0xb0(%ebx)
  p->iotime = 0;
80103820:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
80103827:	00 00 00 
  p->priority = DEFAULT_PRIORITY_PBS;
8010382a:	c7 83 8c 00 00 00 3c 	movl   $0x3c,0x8c(%ebx)
80103831:	00 00 00 
  p->n_run = 0;
80103834:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
8010383b:	00 00 00 
  p->queue = 0;
8010383e:	c7 83 90 00 00 00 00 	movl   $0x0,0x90(%ebx)
80103845:	00 00 00 
  p->curr_q_ticks = 0;
80103848:	c7 83 a8 00 00 00 00 	movl   $0x0,0xa8(%ebx)
8010384f:	00 00 00 
    p->q_ticks[i] = 0;
80103852:	c7 83 94 00 00 00 00 	movl   $0x0,0x94(%ebx)
80103859:	00 00 00 
8010385c:	c7 83 98 00 00 00 00 	movl   $0x0,0x98(%ebx)
80103863:	00 00 00 
80103866:	c7 83 9c 00 00 00 00 	movl   $0x0,0x9c(%ebx)
8010386d:	00 00 00 
80103870:	c7 83 a0 00 00 00 00 	movl   $0x0,0xa0(%ebx)
80103877:	00 00 00 
8010387a:	c7 83 a4 00 00 00 00 	movl   $0x0,0xa4(%ebx)
80103881:	00 00 00 
  release(&ptable.lock);
80103884:	68 40 2d 11 80       	push   $0x80112d40
  p->pid = nextpid++;
80103889:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
8010388f:	e8 ac 11 00 00       	call   80104a40 <release>

  // Allocate kernel stack.
  if ((p->kstack = kalloc()) == 0)
80103894:	e8 e7 ed ff ff       	call   80102680 <kalloc>
80103899:	83 c4 10             	add    $0x10,%esp
8010389c:	89 43 08             	mov    %eax,0x8(%ebx)
8010389f:	85 c0                	test   %eax,%eax
801038a1:	74 56                	je     801038f9 <allocproc+0x149>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
801038a3:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
801038a9:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
801038ac:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
801038b1:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint *)sp = (uint)trapret;
801038b4:	c7 40 14 2f 5e 10 80 	movl   $0x80105e2f,0x14(%eax)
  p->context = (struct context *)sp;
801038bb:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
801038be:	6a 14                	push   $0x14
801038c0:	6a 00                	push   $0x0
801038c2:	50                   	push   %eax
801038c3:	e8 98 12 00 00       	call   80104b60 <memset>
...
801038cb:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
801038ce:	c7 40 10 10 39 10 80 	movl   $0x80103910,0x10(%eax)
}
801038d5:	89 d8                	mov    %ebx,%eax
801038d7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801038da:	c9                   	leave  
801038db:	c3                   	ret    
...
801038e3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801038e5:	68 40 2d 11 80       	push   $0x80112d40
801038ea:	e8 51 11 00 00       	call   80104a40 <release>
}
...
8010391b:	e8 20 11 00 00       	call   80104a40 <release>
...
8010392e:	66 90                	xchg   %ax,%ax
    first = 0;
80103930:	c7 05 00 b0 10 80 00 	movl   $0x0,0x8010b000
80103937:	00 00 00 
    iinit(ROOTDEV);
8010393a:	83 ec 0c             	sub    $0xc,%esp
8010393d:	6a 01                	push   $0x1
8010393f:	e8 1c dc ff ff       	call   80101560 <iinit>
    initlog(ROOTDEV);
80103944:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010394b:	e8 70 f3 ff ff       	call   80102cc0 <initlog>
}
...
80103960 <updateRunsandOthers>:
{
80103960:	55                   	push   %ebp
80103961:	89 e5                	mov    %esp,%ebp
80103963:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80103966:	68 40 2d 11 80       	push   $0x80112d40
8010396b:	e8 30 11 00 00       	call   80104aa0 <acquire>
80103970:	83 c4 10             	add    $0x10,%esp
  for (struct proc *p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103973:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103978:	eb 25                	jmp    8010399f <updateRunsandOthers+0x3f>
8010397a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (p->state == SLEEPING)
80103980:	83 fa 02             	cmp    $0x2,%edx
80103983:	75 0e                	jne    80103993 <updateRunsandOthers+0x33>
      p->iotime++;           //increase iotime
80103985:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
      p->lastWorkingticks++; //increase last working ticks - it is working basically I/O
8010398c:	83 80 b0 00 00 00 01 	addl   $0x1,0xb0(%eax)
  for (struct proc *p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103993:	05 b4 00 00 00       	add    $0xb4,%eax
80103998:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
8010399d:	74 30                	je     801039cf <updateRunsandOthers+0x6f>
    if (p->state == RUNNING)
8010399f:	8b 50 0c             	mov    0xc(%eax),%edx
801039a2:	83 fa 04             	cmp    $0x4,%edx
801039a5:	75 d9                	jne    80103980 <updateRunsandOthers+0x20>
      p->q_ticks[p->queue]++; // increase q_ticks
801039a7:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
      p->rtime++;             //increase rtime
801039ad:	83 80 80 00 00 00 01 	addl   $0x1,0x80(%eax)
      p->q_ticks[p->queue]++; // increase q_ticks
801039b4:	83 84 90 94 00 00 00 	addl   $0x1,0x94(%eax,%edx,4)
801039bb:	01 
      p->curr_q_ticks++;      //increase ticks in current queue
801039bc:	83 80 a8 00 00 00 01 	addl   $0x1,0xa8(%eax)
  for (struct proc *p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801039c3:	05 b4 00 00 00       	add    $0xb4,%eax
801039c8:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
801039cd:	75 d0                	jne    8010399f <updateRunsandOthers+0x3f>
  release(&ptable.lock);
801039cf:	83 ec 0c             	sub    $0xc,%esp
801039d2:	68 40 2d 11 80       	push   $0x80112d40
801039d7:	e8 64 10 00 00       	call   80104a40 <release>
}
...
801039f6:	68 a0 7c 10 80       	push   $0x80107ca0
801039fb:	68 40 2d 11 80       	push   $0x80112d40
80103a00:	e8 cb 0e 00 00       	call   801048d0 <initlock>
}
...
80103a1a:	75 46                	jne    80103a62 <mycpu+0x52>
  apicid = lapicid();
80103a1c:	e8 cf ee ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i)
80103a21:	8b 35 a4 27 11 80    	mov    0x801127a4,%esi
...
80103a3d:	0f b6 99 c0 27 11 80 	movzbl -0x7feed840(%ecx),%ebx
80103a44:	39 c3                	cmp    %eax,%ebx
80103a46:	75 e8                	jne    80103a30 <mycpu+0x20>
}
80103a48:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103a4b:	8d 81 c0 27 11 80    	lea    -0x7feed840(%ecx),%eax
}
80103a51:	5b                   	pop    %ebx
80103a52:	5e                   	pop    %esi
80103a53:	5d                   	pop    %ebp
...
80103a7b:	c9                   	leave  
  return mycpu() - cpus;
80103a7c:	2d c0 27 11 80       	sub    $0x801127c0,%eax
...
80103a94:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103a97:	e8 b4 0e 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103a9c:	e8 6f ff ff ff       	call   80103a10 <mycpu>
  p = c->proc;
80103aa1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa7:	e8 f4 0e 00 00       	call   801049a0 <popcli>
}
...
80103ac4:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103ac7:	e8 e4 fc ff ff       	call   801037b0 <allocproc>
80103acc:	89 c3                	mov    %eax,%ebx
  initproc = p;
80103ace:	a3 74 5a 11 80       	mov    %eax,0x80115a74
  if ((p->pgdir = setupkvm()) == 0)
80103ad3:	e8 28 39 00 00       	call   80107400 <setupkvm>
...
80103aeb:	68 80 b4 10 80       	push   $0x8010b480
80103af0:	50                   	push   %eax
80103af1:	e8 ba 35 00 00       	call   801070b0 <inituvm>
...
80103b06:	e8 55 10 00 00       	call   80104b60 <memset>
...
80103b5f:	68 d0 7c 10 80       	push   $0x80107cd0
80103b64:	50                   	push   %eax
80103b65:	e8 b6 11 00 00       	call   80104d20 <safestrcpy>
  p->cwd = namei("/");
80103b6a:	c7 04 24 d9 7c 10 80 	movl   $0x80107cd9,(%esp)
80103b71:	e8 2a e5 ff ff       	call   801020a0 <namei>
80103b76:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103b79:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103b80:	e8 1b 0f 00 00       	call   80104aa0 <acquire>
  p->state = RUNNABLE;
80103b85:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103b8c:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103b93:	e8 a8 0e 00 00       	call   80104a40 <release>
}
...
80103ba3:	68 b7 7c 10 80       	push   $0x80107cb7
...
80103bb5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103bb8:	e8 93 0d 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103bbd:	e8 4e fe ff ff       	call   80103a10 <mycpu>
  p = c->proc;
80103bc2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bc8:	e8 d3 0d 00 00       	call   801049a0 <popcli>
  sz = curproc->sz;
...
80103bdb:	e8 c0 33 00 00       	call   80106fa0 <switchuvm>
  return 0;
...
80103bfa:	e8 21 36 00 00       	call   80107220 <allocuvm>
...
80103c1a:	e8 31 37 00 00       	call   80107350 <deallocuvm>
...
80103c36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103c39:	e8 12 0d 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103c3e:	e8 cd fd ff ff       	call   80103a10 <mycpu>
  p = c->proc;
80103c43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c49:	e8 52 0d 00 00       	call   801049a0 <popcli>
  if ((np = allocproc()) == 0)
...
80103c68:	e8 83 38 00 00       	call   801074f0 <copyuvm>
...
80103ce1:	e8 3a 10 00 00       	call   80104d20 <safestrcpy>
  pid = np->pid;
80103ce6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103ce9:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103cf0:	e8 ab 0d 00 00       	call   80104aa0 <acquire>
  np->state = RUNNABLE;
80103cf5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103cfc:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80103d03:	e8 38 0d 00 00       	call   80104a40 <release>
  return pid;
...
80103d25:	e8 96 e7 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
...
80103d74:	31 ff                	xor    %edi,%edi
    acquire(&ptable.lock);       //lock table
80103d76:	68 40 2d 11 80       	push   $0x80112d40
80103d7b:	e8 20 0d 00 00       	call   80104aa0 <acquire>
80103d80:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d83:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103d88:	eb 1b                	jmp    80103da5 <scheduler+0x55>
80103d8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      else if (p->ctime < nextone->ctime)
80103d90:	8b 57 7c             	mov    0x7c(%edi),%edx
80103d93:	39 50 7c             	cmp    %edx,0x7c(%eax)
80103d96:	0f 4c f8             	cmovl  %eax,%edi
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d99:	05 b4 00 00 00       	add    $0xb4,%eax
80103d9e:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
80103da3:	74 1b                	je     80103dc0 <scheduler+0x70>
      if (p->state != RUNNABLE)
80103da5:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103da9:	75 ee                	jne    80103d99 <scheduler+0x49>
      if (nextone == NULL)
80103dab:	85 ff                	test   %edi,%edi
80103dad:	75 e1                	jne    80103d90 <scheduler+0x40>
80103daf:	89 c7                	mov    %eax,%edi
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103db1:	05 b4 00 00 00       	add    $0xb4,%eax
80103db6:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
80103dbb:	75 e8                	jne    80103da5 <scheduler+0x55>
80103dbd:	8d 76 00             	lea    0x0(%esi),%esi
    if (nextone != NULL)
80103dc0:	85 ff                	test   %edi,%edi
80103dc2:	74 62                	je     80103e26 <scheduler+0xd6>
      switchuvm(p);
80103dc4:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103dc7:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103dcd:	57                   	push   %edi
80103dce:	e8 cd 31 00 00       	call   80106fa0 <switchuvm>
      p->lastWorkingticks = ticks;
80103dd3:	a1 80 5a 11 80       	mov    0x80115a80,%eax
      p->n_run++;
80103dd8:	83 87 ac 00 00 00 01 	addl   $0x1,0xac(%edi)
      p->state = RUNNING;
80103ddf:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      p->lastWorkingticks = ticks;
80103de6:	89 87 b0 00 00 00    	mov    %eax,0xb0(%edi)
      cprintf("Process ID: %d, creation_time: %d, ticks: %d\n", p->pid, p->ctime, ticks);
80103dec:	50                   	push   %eax
80103ded:	ff 77 7c             	push   0x7c(%edi)
80103df0:	ff 77 10             	push   0x10(%edi)
80103df3:	68 ac 7d 10 80       	push   $0x80107dac
80103df8:	e8 a3 c8 ff ff       	call   801006a0 <cprintf>
      swtch(&(c->scheduler), p->context);
80103dfd:	83 c4 18             	add    $0x18,%esp
80103e00:	ff 77 1c             	push   0x1c(%edi)
80103e03:	56                   	push   %esi
80103e04:	e8 72 0f 00 00       	call   80104d7b <swtch>
      switchkvm();
80103e09:	e8 82 31 00 00       	call   80106f90 <switchkvm>
      p->lastWorkingticks = ticks;
80103e0e:	a1 80 5a 11 80       	mov    0x80115a80,%eax
      c->proc = 0;
80103e13:	83 c4 10             	add    $0x10,%esp
      p->lastWorkingticks = ticks;
80103e16:	89 87 b0 00 00 00    	mov    %eax,0xb0(%edi)
      c->proc = 0;
80103e1c:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103e23:	00 00 00 
    release(&ptable.lock);
80103e26:	83 ec 0c             	sub    $0xc,%esp
80103e29:	68 40 2d 11 80       	push   $0x80112d40
80103e2e:	e8 0d 0c 00 00       	call   80104a40 <release>
  {
80103e33:	83 c4 10             	add    $0x10,%esp
80103e36:	e9 35 ff ff ff       	jmp    80103d70 <scheduler+0x20>
...
80103e44:	53                   	push   %ebx
  pushcli();
80103e45:	e8 06 0b 00 00       	call   80104950 <pushcli>
  c = mycpu();
80103e4a:	e8 c1 fb ff ff       	call   80103a10 <mycpu>
  p = c->proc;
80103e4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e55:	e8 46 0b 00 00       	call   801049a0 <popcli>
  if (!holding(&ptable.lock))
80103e5a:	83 ec 0c             	sub    $0xc,%esp
80103e5d:	68 40 2d 11 80       	push   $0x80112d40
80103e62:	e8 99 0b 00 00       	call   80104a00 <holding>
80103e67:	83 c4 10             	add    $0x10,%esp
80103e6a:	85 c0                	test   %eax,%eax
80103e6c:	74 4f                	je     80103ebd <sched+0x7d>
  if (mycpu()->ncli != 1)
80103e6e:	e8 9d fb ff ff       	call   80103a10 <mycpu>
...
80103e87:	75 41                	jne    80103eca <sched+0x8a>
  intena = mycpu()->intena;
80103e89:	e8 82 fb ff ff       	call   80103a10 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103e8e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103e91:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103e97:	e8 74 fb ff ff       	call   80103a10 <mycpu>
80103e9c:	83 ec 08             	sub    $0x8,%esp
80103e9f:	ff 70 04             	push   0x4(%eax)
80103ea2:	53                   	push   %ebx
80103ea3:	e8 d3 0e 00 00       	call   80104d7b <swtch>
  mycpu()->intena = intena;
80103ea8:	e8 63 fb ff ff       	call   80103a10 <mycpu>
}
...
80103f06:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103f09:	e8 82 fb ff ff       	call   80103a90 <myproc>
  if (curproc == initproc)
80103f0e:	39 05 74 5a 11 80    	cmp    %eax,0x80115a74
...
80103f6a:	e8 31 0b 00 00       	call   80104aa0 <acquire>
...
wakeup1(void *chan)
{
  ...
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f75:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103f7a:	eb 10                	jmp    80103f8c <exit+0x8c>
80103f7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f80:	05 b4 00 00 00       	add    $0xb4,%eax
80103f85:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
...
80103f97:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f9e:	05 b4 00 00 00       	add    $0xb4,%eax
80103fa3:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
80103fa8:	75 e2                	jne    80103f8c <exit+0x8c>
      p->parent = initproc;
80103faa:	8b 0d 74 5a 11 80    	mov    0x80115a74,%ecx
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fb0:	ba 74 2d 11 80       	mov    $0x80112d74,%edx
80103fb5:	eb 17                	jmp    80103fce <exit+0xce>
80103fb7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103fbe:	66 90                	xchg   %ax,%ax
80103fc0:	81 c2 b4 00 00 00    	add    $0xb4,%edx
80103fc6:	81 fa 74 5a 11 80    	cmp    $0x80115a74,%edx
...
80103fda:	75 e4                	jne    80103fc0 <exit+0xc0>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fdc:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103fe1:	eb 11                	jmp    80103ff4 <exit+0xf4>
80103fe3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fe7:	90                   	nop
80103fe8:	05 b4 00 00 00       	add    $0xb4,%eax
80103fed:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
...
8010404f:	83 fe 64             	cmp    $0x64,%esi
80104052:	0f 87 b8 00 00 00    	ja     80104110 <set_priority+0xd0>
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104058:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
8010405d:	eb 13                	jmp    80104072 <set_priority+0x32>
8010405f:	90                   	nop
80104060:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
80104066:	81 fb 74 5a 11 80    	cmp    $0x80115a74,%ebx
8010406c:	0f 84 9e 00 00 00    	je     80104110 <set_priority+0xd0>
    if (p->pid == pid)
80104072:	39 43 10             	cmp    %eax,0x10(%ebx)
80104075:	75 e9                	jne    80104060 <set_priority+0x20>
      acquire(&ptable.lock);
80104077:	83 ec 0c             	sub    $0xc,%esp
8010407a:	68 40 2d 11 80       	push   $0x80112d40
8010407f:	e8 1c 0a 00 00       	call   80104aa0 <acquire>
      returnValue = p->priority;
80104084:	8b bb 8c 00 00 00    	mov    0x8c(%ebx),%edi
      if (returnValue > new_priority) //in this case yield
8010408a:	83 c4 10             	add    $0x10,%esp
      p->priority = new_priority;
8010408d:	89 b3 8c 00 00 00    	mov    %esi,0x8c(%ebx)
      if (returnValue > new_priority) //in this case yield
80104093:	39 fe                	cmp    %edi,%esi
80104095:	7c 21                	jl     801040b8 <set_priority+0x78>
      release(&ptable.lock);
80104097:	83 ec 0c             	sub    $0xc,%esp
8010409a:	68 40 2d 11 80       	push   $0x80112d40
8010409f:	e8 9c 09 00 00       	call   80104a40 <release>
801040a4:	83 c4 10             	add    $0x10,%esp
}
801040a7:	8d 65 f4             	lea    -0xc(%ebp),%esp
801040aa:	89 f8                	mov    %edi,%eax
801040ac:	5b                   	pop    %ebx
801040ad:	5e                   	pop    %esi
801040ae:	5f                   	pop    %edi
801040af:	5d                   	pop    %ebp
...
801040bb:	68 40 2d 11 80       	push   $0x80112d40
801040c0:	e8 7b 09 00 00       	call   80104a40 <release>
  acquire(&ptable.lock); //DOC: yieldlock
801040c5:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801040cc:	e8 cf 09 00 00       	call   80104aa0 <acquire>
  pushcli();
801040d1:	e8 7a 08 00 00       	call   80104950 <pushcli>
  c = mycpu();
801040d6:	e8 35 f9 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
801040db:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040e1:	e8 ba 08 00 00       	call   801049a0 <popcli>
  myproc()->state = RUNNABLE;
801040e6:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
801040ed:	e8 4e fd ff ff       	call   80103e40 <sched>
  release(&ptable.lock);
801040f2:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801040f9:	e8 42 09 00 00       	call   80104a40 <release>
}
801040fe:	83 c4 10             	add    $0x10,%esp
}
80104101:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104104:	89 f8                	mov    %edi,%eax
80104106:	5b                   	pop    %ebx
80104107:	5e                   	pop    %esi
80104108:	5f                   	pop    %edi
80104109:	5d                   	pop    %ebp
...
80104110:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return -1;
80104113:	bf ff ff ff ff       	mov    $0xffffffff,%edi
}
80104118:	5b                   	pop    %ebx
80104119:	89 f8                	mov    %edi,%eax
8010411b:	5e                   	pop    %esi
8010411c:	5f                   	pop    %edi
8010411d:	5d                   	pop    %ebp
8010411e:	c3                   	ret    
...
80104124:	53                   	push   %ebx
  pushcli();
80104125:	e8 26 08 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010412a:	e8 e1 f8 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
8010412f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104135:	e8 66 08 00 00       	call   801049a0 <popcli>
  acquire(&ptable.lock);
8010413a:	83 ec 0c             	sub    $0xc,%esp
8010413d:	68 40 2d 11 80       	push   $0x80112d40
80104142:	e8 59 09 00 00       	call   80104aa0 <acquire>
80104147:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010414a:	31 c0                	xor    %eax,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010414c:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
80104151:	eb 13                	jmp    80104166 <wait+0x46>
80104153:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104157:	90                   	nop
80104158:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
8010415e:	81 fb 74 5a 11 80    	cmp    $0x80115a74,%ebx
80104164:	74 1e                	je     80104184 <wait+0x64>
      if (p->parent != curproc)
80104166:	39 73 14             	cmp    %esi,0x14(%ebx)
80104169:	75 ed                	jne    80104158 <wait+0x38>
      if (p->state == ZOMBIE)
8010416b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010416f:	74 5f                	je     801041d0 <wait+0xb0>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104171:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
      havekids = 1;
80104177:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010417c:	81 fb 74 5a 11 80    	cmp    $0x80115a74,%ebx
80104182:	75 e2                	jne    80104166 <wait+0x46>
    if (!havekids || curproc->killed)
80104184:	85 c0                	test   %eax,%eax
80104186:	0f 84 9a 00 00 00    	je     80104226 <wait+0x106>
8010418c:	8b 46 24             	mov    0x24(%esi),%eax
8010418f:	85 c0                	test   %eax,%eax
80104191:	0f 85 8f 00 00 00    	jne    80104226 <wait+0x106>
  pushcli();
80104197:	e8 b4 07 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010419c:	e8 6f f8 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
801041a1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801041a7:	e8 f4 07 00 00       	call   801049a0 <popcli>
  if (p == 0)
801041ac:	85 db                	test   %ebx,%ebx
801041ae:	0f 84 89 00 00 00    	je     8010423d <wait+0x11d>
  p->chan = chan;
801041b4:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801041b7:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801041be:	e8 7d fc ff ff       	call   80103e40 <sched>
  p->chan = 0;
801041c3:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801041ca:	e9 7b ff ff ff       	jmp    8010414a <wait+0x2a>
801041cf:	90                   	nop
        kfree(p->kstack);
...
801041e9:	e8 92 31 00 00       	call   80107380 <freevm>
        p->pid = 0;
...
80104215:	e8 26 08 00 00       	call   80104a40 <release>
        return pid;
...
80104233:	e8 08 08 00 00       	call   80104a40 <release>
      return -1;
80104238:	83 c4 10             	add    $0x10,%esp
8010423b:	eb e0                	jmp    8010421d <wait+0xfd>
    panic("sleep");
8010423d:	83 ec 0c             	sub    $0xc,%esp
80104240:	68 34 7d 10 80       	push   $0x80107d34
...
80104254:	53                   	push   %ebx
  pushcli();
80104255:	e8 f6 06 00 00       	call   80104950 <pushcli>
  c = mycpu();
8010425a:	e8 b1 f7 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
8010425f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104265:	e8 36 07 00 00       	call   801049a0 <popcli>
  acquire(&ptable.lock);
8010426a:	83 ec 0c             	sub    $0xc,%esp
8010426d:	68 40 2d 11 80       	push   $0x80112d40
80104272:	e8 29 08 00 00       	call   80104aa0 <acquire>
80104277:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010427a:	31 c0                	xor    %eax,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010427c:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
80104281:	eb 13                	jmp    80104296 <waitx+0x46>
80104283:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104287:	90                   	nop
80104288:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
8010428e:	81 fb 74 5a 11 80    	cmp    $0x80115a74,%ebx
80104294:	74 1e                	je     801042b4 <waitx+0x64>
      if (p->parent != curproc)
80104296:	39 73 14             	cmp    %esi,0x14(%ebx)
80104299:	75 ed                	jne    80104288 <waitx+0x38>
      if (p->state == ZOMBIE)
8010429b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010429f:	74 5f                	je     80104300 <waitx+0xb0>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042a1:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
      havekids = 1;
801042a7:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042ac:	81 fb 74 5a 11 80    	cmp    $0x80115a74,%ebx
801042b2:	75 e2                	jne    80104296 <waitx+0x46>
    if (!havekids || curproc->killed)
801042b4:	85 c0                	test   %eax,%eax
801042b6:	0f 84 3a 01 00 00    	je     801043f6 <waitx+0x1a6>
801042bc:	8b 46 24             	mov    0x24(%esi),%eax
801042bf:	85 c0                	test   %eax,%eax
801042c1:	0f 85 2f 01 00 00    	jne    801043f6 <waitx+0x1a6>
  pushcli();
801042c7:	e8 84 06 00 00       	call   80104950 <pushcli>
  c = mycpu();
801042cc:	e8 3f f7 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
801042d1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042d7:	e8 c4 06 00 00       	call   801049a0 <popcli>
  if (p == 0)
801042dc:	85 db                	test   %ebx,%ebx
801042de:	0f 84 29 01 00 00    	je     8010440d <waitx+0x1bd>
  p->chan = chan;
801042e4:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801042e7:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801042ee:	e8 4d fb ff ff       	call   80103e40 <sched>
  p->chan = 0;
801042f3:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801042fa:	e9 7b ff ff ff       	jmp    8010427a <waitx+0x2a>
801042ff:	90                   	nop
        *rtime = p->rtime; //! update rtime and wtime passed as arguments
80104300:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80104306:	8b 55 0c             	mov    0xc(%ebp),%edx
        kfree(p->kstack);
80104309:	83 ec 0c             	sub    $0xc,%esp
        *rtime = p->rtime; //! update rtime and wtime passed as arguments
8010430c:	89 02                	mov    %eax,(%edx)
        *wtime = p->etime - (p->ctime + p->rtime + p->iotime);
8010430e:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
80104314:	03 43 7c             	add    0x7c(%ebx),%eax
80104317:	03 83 88 00 00 00    	add    0x88(%ebx),%eax
8010431d:	29 c2                	sub    %eax,%edx
8010431f:	8b 45 08             	mov    0x8(%ebp),%eax
80104322:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
80104324:	8b 73 10             	mov    0x10(%ebx),%esi
        p->etime = 0;
80104327:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
8010432e:	00 00 00 
        p->ctime = 0;
80104331:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->rtime = 0;
80104338:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
8010433f:	00 00 00 
        p->iotime = 0;
80104342:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
80104349:	00 00 00 
        p->lastWorkingticks = 0;
8010434c:	c7 83 b0 00 00 00 00 	movl   $0x0,0xb0(%ebx)
80104353:	00 00 00 
        p->n_run = 0;
80104356:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
8010435d:	00 00 00 
        p->priority = 0;
80104360:	c7 83 8c 00 00 00 00 	movl   $0x0,0x8c(%ebx)
80104367:	00 00 00 
        p->q_ticks[0] = p->q_ticks[1] = p->q_ticks[2] = p->q_ticks[3] = p->q_ticks[4] = 0;
8010436a:	c7 83 a4 00 00 00 00 	movl   $0x0,0xa4(%ebx)
80104371:	00 00 00 
80104374:	c7 83 a0 00 00 00 00 	movl   $0x0,0xa0(%ebx)
8010437b:	00 00 00 
8010437e:	c7 83 9c 00 00 00 00 	movl   $0x0,0x9c(%ebx)
80104385:	00 00 00 
80104388:	c7 83 98 00 00 00 00 	movl   $0x0,0x98(%ebx)
8010438f:	00 00 00 
80104392:	c7 83 94 00 00 00 00 	movl   $0x0,0x94(%ebx)
80104399:	00 00 00 
        p->curr_q_ticks = 0;
8010439c:	c7 83 a8 00 00 00 00 	movl   $0x0,0xa8(%ebx)
801043a3:	00 00 00 
        kfree(p->kstack);
...
801043b9:	e8 c2 2f 00 00       	call   80107380 <freevm>
        p->pid = 0;
...
801043d7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801043de:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801043e5:	e8 56 06 00 00       	call   80104a40 <release>
        return pid;
...
801043f9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801043fe:	68 40 2d 11 80       	push   $0x80112d40
80104403:	e8 38 06 00 00       	call   80104a40 <release>
      return -1;
80104408:	83 c4 10             	add    $0x10,%esp
8010440b:	eb e0                	jmp    801043ed <waitx+0x19d>
    panic("sleep");
8010440d:	83 ec 0c             	sub    $0xc,%esp
80104410:	68 34 7d 10 80       	push   $0x80107d34
80104415:	e8 66 bf ff ff       	call   80100380 <panic>
...
80104424:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock); //DOC: yieldlock
80104427:	68 40 2d 11 80       	push   $0x80112d40
8010442c:	e8 6f 06 00 00       	call   80104aa0 <acquire>
  pushcli();
80104431:	e8 1a 05 00 00       	call   80104950 <pushcli>
  c = mycpu();
80104436:	e8 d5 f5 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
...
80104446:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
8010444d:	e8 ee f9 ff ff       	call   80103e40 <sched>
  release(&ptable.lock);
80104452:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
80104459:	e8 e2 05 00 00       	call   80104a40 <release>
}
...
8010447c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010447f:	e8 cc 04 00 00       	call   80104950 <pushcli>
  c = mycpu();
80104484:	e8 87 f5 ff ff       	call   80103a10 <mycpu>
  p = c->proc;
...
8010449e:	74 76                	je     80104516 <sleep+0xa6>
  if (lk != &ptable.lock)
801044a0:	81 fe 40 2d 11 80    	cmp    $0x80112d40,%esi
801044a6:	74 50                	je     801044f8 <sleep+0x88>
    acquire(&ptable.lock); //DOC: sleeplock1
801044a8:	83 ec 0c             	sub    $0xc,%esp
801044ab:	68 40 2d 11 80       	push   $0x80112d40
801044b0:	e8 eb 05 00 00       	call   80104aa0 <acquire>
    release(lk);
801044b5:	89 34 24             	mov    %esi,(%esp)
801044b8:	e8 83 05 00 00       	call   80104a40 <release>
  p->chan = chan;
801044bd:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
801044c0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801044c7:	e8 74 f9 ff ff       	call   80103e40 <sched>
  p->chan = 0;
801044cc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801044d3:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
801044da:	e8 61 05 00 00       	call   80104a40 <release>
    acquire(lk);
...
801044eb:	5d                   	pop    %ebp
    acquire(lk);
801044ec:	e9 af 05 00 00       	jmp    80104aa0 <acquire>
...
801044fb:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80104502:	e8 39 f9 ff ff       	call   80103e40 <sched>
  p->chan = 0;
...
80104519:	68 3a 7d 10 80       	push   $0x80107d3a
8010451e:	e8 5d be ff ff       	call   80100380 <panic>
    panic("sleep");
80104523:	83 ec 0c             	sub    $0xc,%esp
80104526:	68 34 7d 10 80       	push   $0x80107d34
...
80104537:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010453a:	68 40 2d 11 80       	push   $0x80112d40
8010453f:	e8 5c 05 00 00       	call   80104aa0 <acquire>
80104544:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104547:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
8010454c:	eb 0e                	jmp    8010455c <wakeup+0x2c>
8010454e:	66 90                	xchg   %ax,%ax
80104550:	05 b4 00 00 00       	add    $0xb4,%eax
80104555:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
...
80104567:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010456e:	05 b4 00 00 00       	add    $0xb4,%eax
80104573:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
80104578:	75 e2                	jne    8010455c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
8010457a:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
80104581:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104584:	c9                   	leave  
  release(&ptable.lock);
80104585:	e9 b6 04 00 00       	jmp    80104a40 <release>
...
80104597:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010459a:	68 40 2d 11 80       	push   $0x80112d40
8010459f:	e8 fc 04 00 00       	call   80104aa0 <acquire>
801045a4:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801045a7:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
801045ac:	eb 0e                	jmp    801045bc <kill+0x2c>
801045ae:	66 90                	xchg   %ax,%ax
801045b0:	05 b4 00 00 00       	add    $0xb4,%eax
801045b5:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
...
801045d8:	68 40 2d 11 80       	push   $0x80112d40
801045dd:	e8 5e 04 00 00       	call   80104a40 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801045f3:	68 40 2d 11 80       	push   $0x80112d40
801045f8:	e8 43 04 00 00       	call   80104a40 <release>
}
...
80104619:	bb e0 2d 11 80       	mov    $0x80112de0,%ebx
...
8010462b:	68 03 81 10 80       	push   $0x80108103
80104630:	e8 6b c0 ff ff       	call   801006a0 <cprintf>
80104635:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104638:	81 c3 b4 00 00 00    	add    $0xb4,%ebx
8010463e:	81 fb e0 5a 11 80    	cmp    $0x80115ae0,%ebx
...
8010464f:	74 e7                	je     80104638 <procdump+0x28>
      state = "???";
80104651:	ba 4b 7d 10 80       	mov    $0x80107d4b,%edx
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104656:	83 f8 05             	cmp    $0x5,%eax
80104659:	77 11                	ja     8010466c <procdump+0x5c>
8010465b:	8b 14 85 dc 7d 10 80 	mov    -0x7fef8224(,%eax,4),%edx
      state = "???";
80104662:	b8 4b 7d 10 80       	mov    $0x80107d4b,%eax
...
80104671:	68 4f 7d 10 80       	push   $0x80107d4f
...
80104698:	e8 53 02 00 00       	call   801048f0 <getcallerpcs>
      for (i = 0; i < 10 && pc[i] != 0; i++)
...
801046ad:	68 a1 77 10 80       	push   $0x801077a1
...
801046dd:	68 40 2d 11 80       	push   $0x80112d40
801046e2:	e8 b9 03 00 00       	call   80104aa0 <acquire>
801046e7:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801046ea:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
801046ef:	90                   	nop
  {
    if (p->state == UNUSED)
801046f0:	8b 50 0c             	mov    0xc(%eax),%edx
801046f3:	85 d2                	test   %edx,%edx
801046f5:	74 76                	je     8010476d <getprocstable+0x9d>
    {
      continue;
    }
    InfoTable[count].pid = p->pid;
801046f7:	8d 14 5b             	lea    (%ebx,%ebx,2),%edx
801046fa:	8b 48 10             	mov    0x10(%eax),%ecx
    ...
    count++;
801046fd:	83 c3 01             	add    $0x1,%ebx
    InfoTable[count].pid = p->pid;
80104700:	c1 e2 04             	shl    $0x4,%edx
80104703:	01 f2                	add    %esi,%edx
80104705:	89 0a                	mov    %ecx,(%edx)
    InfoTable[count].state = p->state;
80104707:	8b 48 0c             	mov    0xc(%eax),%ecx
8010470a:	89 4a 04             	mov    %ecx,0x4(%edx)
    InfoTable[count].priority = p->priority;
8010470d:	8b 88 8c 00 00 00    	mov    0x8c(%eax),%ecx
80104713:	89 4a 0c             	mov    %ecx,0xc(%edx)
    InfoTable[count].rtime = p->rtime;
80104716:	8b 88 80 00 00 00    	mov    0x80(%eax),%ecx
8010471c:	89 4a 08             	mov    %ecx,0x8(%edx)
    InfoTable[count].ticks[0] = p->q_ticks[0];
8010471f:	8b 88 94 00 00 00    	mov    0x94(%eax),%ecx
80104725:	89 4a 1c             	mov    %ecx,0x1c(%edx)
    InfoTable[count].ticks[1] = p->q_ticks[1];
80104728:	8b 88 98 00 00 00    	mov    0x98(%eax),%ecx
8010472e:	89 4a 20             	mov    %ecx,0x20(%edx)
    InfoTable[count].ticks[2] = p->q_ticks[2];
80104731:	8b 88 9c 00 00 00    	mov    0x9c(%eax),%ecx
80104737:	89 4a 24             	mov    %ecx,0x24(%edx)
    InfoTable[count].ticks[3] = p->q_ticks[3];
8010473a:	8b 88 a0 00 00 00    	mov    0xa0(%eax),%ecx
80104740:	89 4a 28             	mov    %ecx,0x28(%edx)
    InfoTable[count].ticks[4] = p->q_ticks[4];
80104743:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80104749:	89 4a 2c             	mov    %ecx,0x2c(%edx)
    InfoTable[count].curq = p->queue;
8010474c:	8b 88 90 00 00 00    	mov    0x90(%eax),%ecx
80104752:	89 4a 10             	mov    %ecx,0x10(%edx)
    InfoTable[count].wtime = ticks - p->lastWorkingticks;
80104755:	8b 0d 80 5a 11 80    	mov    0x80115a80,%ecx
8010475b:	2b 88 b0 00 00 00    	sub    0xb0(%eax),%ecx
80104761:	89 4a 18             	mov    %ecx,0x18(%edx)
    InfoTable[count].n_run = p->n_run;
80104764:	8b 88 ac 00 00 00    	mov    0xac(%eax),%ecx
8010476a:	89 4a 14             	mov    %ecx,0x14(%edx)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010476d:	05 b4 00 00 00       	add    $0xb4,%eax
80104772:	3d 74 5a 11 80       	cmp    $0x80115a74,%eax
80104777:	0f 85 73 ff ff ff    	jne    801046f0 <getprocstable+0x20>
  }
  release(&ptable.lock);
8010477d:	83 ec 0c             	sub    $0xc,%esp
80104780:	68 40 2d 11 80       	push   $0x80112d40
80104785:	e8 b6 02 00 00       	call   80104a40 <release>
  p = 0;
  return count;
}
...
801047aa:	68 f4 7d 10 80       	push   $0x80107df4
...
80104805:	e8 66 fc ff ff       	call   80104470 <sleep>
  while (lk->locked) {
...
80104813:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104819:	e8 72 f2 ff ff       	call   80103a90 <myproc>
...
80104864:	e8 c7 fc ff ff       	call   80104530 <wakeup>
  release(&lk->lk);
...
801048bb:	e8 d0 f1 ff ff       	call   80103a90 <myproc>
...
8010497a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104980:	e8 8b f0 ff ff       	call   80103a10 <mycpu>
...
801049cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801049d0:	e8 3b f0 ff ff       	call   80103a10 <mycpu>
...
801049e5:	68 ff 7d 10 80       	push   $0x80107dff
801049ea:	e8 91 b9 ff ff       	call   80100380 <panic>
    panic("popcli");
801049ef:	83 ec 0c             	sub    $0xc,%esp
801049f2:	68 16 7e 10 80       	push   $0x80107e16
...
80104a23:	e8 e8 ef ff ff       	call   80103a10 <mycpu>
...
80104adc:	e8 2f ef ff ff       	call   80103a10 <mycpu>
...
80104b3b:	e8 d0 ee ff ff       	call   80103a10 <mycpu>
...
80104b50:	68 25 7e 10 80       	push   $0x80107e25
...
80104d97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104d9a:	e8 f1 ec ff ff       	call   80103a90 <myproc>
...
80104dd7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104dda:	e8 b1 ec ff ff       	call   80103a90 <myproc>
...
80104e25:	e8 66 ec ff ff       	call   80103a90 <myproc>
...
80104e33:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e36:	e8 55 ec ff ff       	call   80103a90 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104e76:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104e79:	e8 12 ec ff ff       	call   80103a90 <myproc>
80104e7e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104e80:	e8 0b ec ff ff       	call   80103a90 <myproc>
...
80104e8e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e91:	e8 fa eb ff ff       	call   80103a90 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ee4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ee5:	e8 a6 eb ff ff       	call   80103a90 <myproc>
...
80104ef3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ef6:	e8 95 eb ff ff       	call   80103a90 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104f0b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104f0e:	e8 7d eb ff ff       	call   80103a90 <myproc>
  if(addr >= curproc->sz)
...
80104f64:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104f67:	e8 24 eb ff ff       	call   80103a90 <myproc>
...
80104f7c:	8b 14 85 60 7e 10 80 	mov    -0x7fef81a0(,%eax,4),%edx
...
80104fa8:	68 2d 7e 10 80       	push   $0x80107e2d
...
80105104:	68 e0 7e 10 80       	push   $0x80107ee0
...
8010511c:	68 df 7e 10 80       	push   $0x80107edf
...
80105131:	68 d3 7e 10 80       	push   $0x80107ed3
...
8010514f:	68 e2 7e 10 80       	push   $0x80107ee2
80105154:	e8 27 b2 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80105159:	83 ec 0c             	sub    $0xc,%esp
8010515c:	68 c4 7e 10 80       	push   $0x80107ec4
...
80105190:	e8 fb e8 ff ff       	call   80103a90 <myproc>
...
80105290:	e8 fb e7 ff ff       	call   80103a90 <myproc>
...
80105310:	e8 7b e7 ff ff       	call   80103a90 <myproc>
...
80105321:	74 25                	je     80105348 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80105323:	e8 68 e7 ff ff       	call   80103a90 <myproc>
  fileclose(f);
...
80105370:	e8 1b e7 ff ff       	call   80103a90 <myproc>
...
8010555d:	58                   	pop    %eax
8010555e:	5a                   	pop    %edx
8010555f:	68 e0 7e 10 80       	push   $0x80107ee0
...
80105578:	68 df 7e 10 80       	push   $0x80107edf
...
80105767:	74 23                	je     8010578c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105769:	e8 22 e3 ff ff       	call   80103a90 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105925:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105928:	e8 63 e1 ff ff       	call   80103a90 <myproc>
...
80105af7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105af9:	e8 92 df ff ff       	call   80103a90 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105b56:	75 f0                	jne    80105b48 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105b58:	e8 33 df ff ff       	call   80103a90 <myproc>
...
{
  return fork();
80105b90:	e9 9b e0 ff ff       	jmp    80103c30 <fork>
...
80105ba3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ba6:	e8 55 e3 ff ff       	call   80103f00 <exit>
...
{
  return wait();
80105bb0:	e9 6b e5 ff ff       	jmp    80104120 <wait>
...
80105bce:	e8 9d f2 ff ff       	call   80104e70 <argptr>
80105bd3:	83 c4 10             	add    $0x10,%esp
80105bd6:	85 c0                	test   %eax,%eax
80105bd8:	78 2e                	js     80105c08 <sys_waitx+0x48>
80105bda:	83 ec 04             	sub    $0x4,%esp
80105bdd:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105be0:	6a 04                	push   $0x4
80105be2:	50                   	push   %eax
80105be3:	6a 01                	push   $0x1
80105be5:	e8 86 f2 ff ff       	call   80104e70 <argptr>
80105bea:	83 c4 10             	add    $0x10,%esp
80105bed:	85 c0                	test   %eax,%eax
80105bef:	78 17                	js     80105c08 <sys_waitx+0x48>
        return -1;

    return waitx(wtime, rtime);
80105bf1:	83 ec 08             	sub    $0x8,%esp
80105bf4:	ff 75 f4             	push   -0xc(%ebp)
80105bf7:	ff 75 f0             	push   -0x10(%ebp)
80105bfa:	e8 51 e6 ff ff       	call   80104250 <waitx>
...
80105c1c:	e8 ff f1 ff ff       	call   80104e20 <argint>
...
80105c31:	e8 ea f1 ff ff       	call   80104e20 <argint>
...
80105c46:	e8 f5 e3 ff ff       	call   80104040 <set_priority>
...
80105c6c:	e8 af f1 ff ff       	call   80104e20 <argint>
...
80105c7e:	e8 0d e9 ff ff       	call   80104590 <kill>
...
80105ca3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105ca6:	e8 e5 dd ff ff       	call   80103a90 <myproc>
...
80105cd6:	e8 d5 de ff ff       	call   80103bb0 <growproc>
...
80105d0d:	e8 0e f1 ff ff       	call   80104e20 <argint>
...
80105d20:	68 a0 5a 11 80       	push   $0x80115aa0
80105d25:	e8 76 ed ff ff       	call   80104aa0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105d2a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105d2d:	8b 1d 80 5a 11 80    	mov    0x80115a80,%ebx
  while(ticks - ticks0 < n){
...
80105d43:	68 a0 5a 11 80       	push   $0x80115aa0
80105d48:	68 80 5a 11 80       	push   $0x80115a80
80105d4d:	e8 1e e7 ff ff       	call   80104470 <sleep>
  while(ticks - ticks0 < n){
80105d52:	a1 80 5a 11 80       	mov    0x80115a80,%eax
...
80105d5f:	73 2f                	jae    80105d90 <sys_sleep+0x90>
    if(myproc()->killed){
80105d61:	e8 2a dd ff ff       	call   80103a90 <myproc>
...
80105d70:	68 a0 5a 11 80       	push   $0x80115aa0
80105d75:	e8 c6 ec ff ff       	call   80104a40 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105d93:	68 a0 5a 11 80       	push   $0x80115aa0
80105d98:	e8 a3 ec ff ff       	call   80104a40 <release>
  return 0;
...
80105db4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105db7:	68 a0 5a 11 80       	push   $0x80115aa0
80105dbc:	e8 df ec ff ff       	call   80104aa0 <acquire>
  xticks = ticks;
80105dc1:	8b 1d 80 5a 11 80    	mov    0x80115a80,%ebx
  release(&tickslock);
80105dc7:	c7 04 24 a0 5a 11 80 	movl   $0x80115aa0,(%esp)
80105dce:	e8 6d ec ff ff       	call   80104a40 <release>
  return xticks;
}
...
80105dee:	e8 7d f0 ff ff       	call   80104e70 <argptr>
80105df3:	83 c4 10             	add    $0x10,%esp
80105df6:	85 c0                	test   %eax,%eax
80105df8:	78 16                	js     80105e10 <sys_getprocstable+0x30>
        return -1;

    return getprocstable(table);
80105dfa:	83 ec 0c             	sub    $0xc,%esp
80105dfd:	ff 75 f4             	push   -0xc(%ebp)
80105e00:	e8 cb e8 ff ff       	call   801046d0 <getprocstable>
...
80105e18:	06                   	push   %es
  pushl %fs
80105e19:	0f a0                	push   %fs
  pushl %gs
80105e1b:	0f a8                	push   %gs
  pushal
80105e1d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105e1e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105e22:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105e24:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105e26:	54                   	push   %esp
  call trap
80105e27:	e8 c4 00 00 00       	call   80105ef0 <trap>
  addl $4, %esp
80105e2c:	83 c4 04             	add    $0x4,%esp
...
80105e2f:	61                   	popa   
  popl %gs
80105e30:	0f a9                	pop    %gs
  popl %fs
80105e32:	0f a1                	pop    %fs
  popl %es
80105e34:	07                   	pop    %es
  popl %ds
80105e35:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105e36:	83 c4 08             	add    $0x8,%esp
  iret
80105e39:	cf                   	iret   
...
80105e50:	8b 14 85 30 b0 10 80 	mov    -0x7fef4fd0(,%eax,4),%edx
80105e57:	c7 04 c5 e2 5a 11 80 	movl   $0x8e000008,-0x7feea51e(,%eax,8)
80105e5e:	08 00 00 8e 
80105e62:	66 89 14 c5 e0 5a 11 	mov    %dx,-0x7feea520(,%eax,8)
80105e69:	80 
80105e6a:	c1 ea 10             	shr    $0x10,%edx
80105e6d:	66 89 14 c5 e6 5a 11 	mov    %dx,-0x7feea51a(,%eax,8)
80105e74:	80 
  for (i = 0; i < 256; i++)
...
80105e7f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80105e82:	a1 30 b1 10 80       	mov    0x8010b130,%eax
80105e87:	c7 05 e2 5c 11 80 08 	movl   $0xef000008,0x80115ce2
80105e8e:	00 00 ef 
  initlock(&tickslock, "time");
80105e91:	68 25 7f 10 80       	push   $0x80107f25
80105e96:	68 a0 5a 11 80       	push   $0x80115aa0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80105e9b:	66 a3 e0 5c 11 80    	mov    %ax,0x80115ce0
80105ea1:	c1 e8 10             	shr    $0x10,%eax
80105ea4:	66 a3 e6 5c 11 80    	mov    %ax,0x80115ce6
  initlock(&tickslock, "time");
80105eaa:	e8 21 ea ff ff       	call   801048d0 <initlock>
}
...
80105ecb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ecf:	b8 e0 5a 11 80       	mov    $0x80115ae0,%eax
...
80105f02:	0f 84 40 01 00 00    	je     80106048 <trap+0x158>
    if (myproc()->killed)
      exit();
    return;
  }
...
80105f0e:	0f 87 7c 00 00 00    	ja     80105f90 <trap+0xa0>
80105f14:	ff 24 85 cc 7f 10 80 	jmp    *-0x7fef8034(,%eax,4)
...
80105f2a:	e8 61 db ff ff       	call   80103a90 <myproc>
80105f2f:	85 c0                	test   %eax,%eax
80105f31:	74 1d                	je     80105f50 <trap+0x60>
80105f33:	e8 58 db ff ff       	call   80103a90 <myproc>
...
80105f4a:	0f 84 c0 01 00 00    	je     80106110 <trap+0x220>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if (myproc() && myproc()->state == RUNNING && tf->trapno == T_IRQ0 + IRQ_TIMER)
80105f50:	e8 3b db ff ff       	call   80103a90 <myproc>
80105f55:	85 c0                	test   %eax,%eax
80105f57:	74 05                	je     80105f5e <trap+0x6e>
80105f59:	e8 32 db ff ff       	call   80103a90 <myproc>
    yield();
#endif
  }
  ...
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105f5e:	e8 2d db ff ff       	call   80103a90 <myproc>
80105f63:	85 c0                	test   %eax,%eax
80105f65:	74 1d                	je     80105f84 <trap+0x94>
80105f67:	e8 24 db ff ff       	call   80103a90 <myproc>
80105f6c:	8b 40 24             	mov    0x24(%eax),%eax
80105f6f:	85 c0                	test   %eax,%eax
80105f71:	74 11                	je     80105f84 <trap+0x94>
80105f73:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105f77:	83 e0 03             	and    $0x3,%eax
80105f7a:	66 83 f8 03          	cmp    $0x3,%ax
80105f7e:	0f 84 f1 00 00 00    	je     80106075 <trap+0x185>
    exit();
}
80105f84:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105f87:	5b                   	pop    %ebx
80105f88:	5e                   	pop    %esi
80105f89:	5f                   	pop    %edi
80105f8a:	5d                   	pop    %ebp
...
80105f90:	e8 fb da ff ff       	call   80103a90 <myproc>
80105f95:	8b 7b 38             	mov    0x38(%ebx),%edi
80105f98:	85 c0                	test   %eax,%eax
80105f9a:	0f 84 8a 01 00 00    	je     8010612a <trap+0x23a>
80105fa0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105fa4:	0f 84 80 01 00 00    	je     8010612a <trap+0x23a>
...
80105fb0:	e8 bb da ff ff       	call   80103a70 <cpuid>
...
80105fc1:	e8 ca da ff ff       	call   80103a90 <myproc>
80105fc6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105fc9:	e8 c2 da ff ff       	call   80103a90 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105fe5:	68 88 7f 10 80       	push   $0x80107f88
80105fea:	e8 b1 a6 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105fef:	83 c4 20             	add    $0x20,%esp
80105ff2:	e8 99 da ff ff       	call   80103a90 <myproc>
80105ff7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105ffe:	e8 8d da ff ff       	call   80103a90 <myproc>
80106003:	85 c0                	test   %eax,%eax
80106005:	0f 85 28 ff ff ff    	jne    80105f33 <trap+0x43>
8010600b:	e9 40 ff ff ff       	jmp    80105f50 <trap+0x60>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106010:	8b 7b 38             	mov    0x38(%ebx),%edi
80106013:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80106017:	e8 54 da ff ff       	call   80103a70 <cpuid>
8010601c:	57                   	push   %edi
8010601d:	56                   	push   %esi
8010601e:	50                   	push   %eax
8010601f:	68 30 7f 10 80       	push   $0x80107f30
80106024:	e8 77 a6 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80106029:	e8 e2 c8 ff ff       	call   80102910 <lapiceoi>
    break;
8010602e:	83 c4 10             	add    $0x10,%esp
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80106031:	e8 5a da ff ff       	call   80103a90 <myproc>
80106036:	85 c0                	test   %eax,%eax
80106038:	0f 85 f5 fe ff ff    	jne    80105f33 <trap+0x43>
8010603e:	e9 0d ff ff ff       	jmp    80105f50 <trap+0x60>
80106043:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106047:	90                   	nop
    if (myproc()->killed)
80106048:	e8 43 da ff ff       	call   80103a90 <myproc>
8010604d:	8b 70 24             	mov    0x24(%eax),%esi
80106050:	85 f6                	test   %esi,%esi
80106052:	0f 85 c8 00 00 00    	jne    80106120 <trap+0x230>
    myproc()->tf = tf;
...
80106060:	e8 fb ee ff ff       	call   80104f60 <syscall>
    if (myproc()->killed)
80106065:	e8 26 da ff ff       	call   80103a90 <myproc>
8010606a:	8b 48 24             	mov    0x24(%eax),%ecx
8010606d:	85 c9                	test   %ecx,%ecx
8010606f:	0f 84 0f ff ff ff    	je     80105f84 <trap+0x94>
}
...
8010607b:	5d                   	pop    %ebp
      exit();
8010607c:	e9 7f de ff ff       	jmp    80103f00 <exit>
80106081:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80106088:	e8 43 02 00 00       	call   801062d0 <uartintr>
    lapiceoi();
8010608d:	e8 7e c8 ff ff       	call   80102910 <lapiceoi>
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80106092:	e8 f9 d9 ff ff       	call   80103a90 <myproc>
80106097:	85 c0                	test   %eax,%eax
80106099:	0f 85 94 fe ff ff    	jne    80105f33 <trap+0x43>
8010609f:	e9 ac fe ff ff       	jmp    80105f50 <trap+0x60>
801060a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801060a8:	e8 23 c7 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
801060ad:	e8 5e c8 ff ff       	call   80102910 <lapiceoi>
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
801060b2:	e8 d9 d9 ff ff       	call   80103a90 <myproc>
801060b7:	85 c0                	test   %eax,%eax
801060b9:	0f 85 74 fe ff ff    	jne    80105f33 <trap+0x43>
801060bf:	e9 8c fe ff ff       	jmp    80105f50 <trap+0x60>
801060c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if (cpuid() == 0)
801060c8:	e8 a3 d9 ff ff       	call   80103a70 <cpuid>
801060cd:	85 c0                	test   %eax,%eax
801060cf:	0f 85 50 fe ff ff    	jne    80105f25 <trap+0x35>
      acquire(&tickslock);
801060d5:	83 ec 0c             	sub    $0xc,%esp
801060d8:	68 a0 5a 11 80       	push   $0x80115aa0
801060dd:	e8 be e9 ff ff       	call   80104aa0 <acquire>
      ticks++;
801060e2:	83 05 80 5a 11 80 01 	addl   $0x1,0x80115a80
      updateRunsandOthers(); //! Updating rtime, iotime, etc during clock ticks - Defined in procs.c
801060e9:	e8 72 d8 ff ff       	call   80103960 <updateRunsandOthers>
      wakeup(&ticks);
801060ee:	c7 04 24 80 5a 11 80 	movl   $0x80115a80,(%esp)
801060f5:	e8 36 e4 ff ff       	call   80104530 <wakeup>
      release(&tickslock);
801060fa:	c7 04 24 a0 5a 11 80 	movl   $0x80115aa0,(%esp)
80106101:	e8 3a e9 ff ff       	call   80104a40 <release>
80106106:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80106109:	e9 17 fe ff ff       	jmp    80105f25 <trap+0x35>
8010610e:	66 90                	xchg   %ax,%ax
    exit();
80106110:	e8 eb dd ff ff       	call   80103f00 <exit>
80106115:	e9 36 fe ff ff       	jmp    80105f50 <trap+0x60>
8010611a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106120:	e8 db dd ff ff       	call   80103f00 <exit>
80106125:	e9 2e ff ff ff       	jmp    80106058 <trap+0x168>
8010612a:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010612d:	e8 3e d9 ff ff       	call   80103a70 <cpuid>
80106132:	83 ec 0c             	sub    $0xc,%esp
80106135:	56                   	push   %esi
80106136:	57                   	push   %edi
80106137:	50                   	push   %eax
80106138:	ff 73 30             	push   0x30(%ebx)
8010613b:	68 54 7f 10 80       	push   $0x80107f54
80106140:	e8 5b a5 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80106145:	83 c4 14             	add    $0x14,%esp
80106148:	68 2a 7f 10 80       	push   $0x80107f2a
8010614d:	e8 2e a2 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80106160:	a1 e0 62 11 80       	mov    0x801162e0,%eax
...
801061e7:	74 78                	je     80106261 <uartinit+0xd1>
  uart = 1;
801061e9:	c7 05 e0 62 11 80 01 	movl   $0x1,0x801162e0
801061f0:	00 00 00 
...
801061fc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801061ff:	bf 4c 80 10 80       	mov    $0x8010804c,%edi
80106204:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80106209:	6a 00                	push   $0x0
8010620b:	6a 04                	push   $0x4
8010620d:	e8 6e c2 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80106219:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80106220:	a1 e0 62 11 80       	mov    0x801162e0,%eax
...
80106235:	e8 f6 c6 ff ff       	call   80102930 <microdelay>
...
80106270 <uartputc>:
  if(!uart)
80106270:	a1 e0 62 11 80       	mov    0x801162e0,%eax
...
801062db:	e8 a0 a5 ff ff       	call   80100880 <consoleintr>
}
...
801062e7:	6a 00                	push   $0x0
  jmp alltraps
801062e9:	e9 29 fb ff ff       	jmp    80105e17 <alltraps>
...
801062f0:	6a 01                	push   $0x1
  jmp alltraps
801062f2:	e9 20 fb ff ff       	jmp    80105e17 <alltraps>
...
801062f9:	6a 02                	push   $0x2
  jmp alltraps
801062fb:	e9 17 fb ff ff       	jmp    80105e17 <alltraps>
...
80106302:	6a 03                	push   $0x3
  jmp alltraps
80106304:	e9 0e fb ff ff       	jmp    80105e17 <alltraps>
...
8010630b:	6a 04                	push   $0x4
  jmp alltraps
8010630d:	e9 05 fb ff ff       	jmp    80105e17 <alltraps>
...
80106314:	6a 05                	push   $0x5
  jmp alltraps
80106316:	e9 fc fa ff ff       	jmp    80105e17 <alltraps>
...
8010631d:	6a 06                	push   $0x6
  jmp alltraps
8010631f:	e9 f3 fa ff ff       	jmp    80105e17 <alltraps>
...
80106326:	6a 07                	push   $0x7
  jmp alltraps
80106328:	e9 ea fa ff ff       	jmp    80105e17 <alltraps>
...
8010632d:	6a 08                	push   $0x8
  jmp alltraps
8010632f:	e9 e3 fa ff ff       	jmp    80105e17 <alltraps>
...
80106336:	6a 09                	push   $0x9
  jmp alltraps
80106338:	e9 da fa ff ff       	jmp    80105e17 <alltraps>
...
8010633d:	6a 0a                	push   $0xa
  jmp alltraps
8010633f:	e9 d3 fa ff ff       	jmp    80105e17 <alltraps>
...
80106344:	6a 0b                	push   $0xb
  jmp alltraps
80106346:	e9 cc fa ff ff       	jmp    80105e17 <alltraps>
...
8010634b:	6a 0c                	push   $0xc
  jmp alltraps
8010634d:	e9 c5 fa ff ff       	jmp    80105e17 <alltraps>
...
80106352:	6a 0d                	push   $0xd
  jmp alltraps
80106354:	e9 be fa ff ff       	jmp    80105e17 <alltraps>
...
80106359:	6a 0e                	push   $0xe
  jmp alltraps
8010635b:	e9 b7 fa ff ff       	jmp    80105e17 <alltraps>
...
80106362:	6a 0f                	push   $0xf
  jmp alltraps
80106364:	e9 ae fa ff ff       	jmp    80105e17 <alltraps>
...
8010636b:	6a 10                	push   $0x10
  jmp alltraps
8010636d:	e9 a5 fa ff ff       	jmp    80105e17 <alltraps>
...
80106372:	6a 11                	push   $0x11
  jmp alltraps
80106374:	e9 9e fa ff ff       	jmp    80105e17 <alltraps>
...
8010637b:	6a 12                	push   $0x12
  jmp alltraps
8010637d:	e9 95 fa ff ff       	jmp    80105e17 <alltraps>
...
80106384:	6a 13                	push   $0x13
  jmp alltraps
80106386:	e9 8c fa ff ff       	jmp    80105e17 <alltraps>
...
8010638d:	6a 14                	push   $0x14
  jmp alltraps
8010638f:	e9 83 fa ff ff       	jmp    80105e17 <alltraps>
...
80106396:	6a 15                	push   $0x15
  jmp alltraps
80106398:	e9 7a fa ff ff       	jmp    80105e17 <alltraps>
...
8010639f:	6a 16                	push   $0x16
  jmp alltraps
801063a1:	e9 71 fa ff ff       	jmp    80105e17 <alltraps>
...
801063a8:	6a 17                	push   $0x17
  jmp alltraps
801063aa:	e9 68 fa ff ff       	jmp    80105e17 <alltraps>
...
801063b1:	6a 18                	push   $0x18
  jmp alltraps
801063b3:	e9 5f fa ff ff       	jmp    80105e17 <alltraps>
...
801063ba:	6a 19                	push   $0x19
  jmp alltraps
801063bc:	e9 56 fa ff ff       	jmp    80105e17 <alltraps>
...
801063c3:	6a 1a                	push   $0x1a
  jmp alltraps
801063c5:	e9 4d fa ff ff       	jmp    80105e17 <alltraps>
...
801063cc:	6a 1b                	push   $0x1b
  jmp alltraps
801063ce:	e9 44 fa ff ff       	jmp    80105e17 <alltraps>
...
801063d5:	6a 1c                	push   $0x1c
  jmp alltraps
801063d7:	e9 3b fa ff ff       	jmp    80105e17 <alltraps>
...
801063de:	6a 1d                	push   $0x1d
  jmp alltraps
801063e0:	e9 32 fa ff ff       	jmp    80105e17 <alltraps>
...
801063e7:	6a 1e                	push   $0x1e
  jmp alltraps
801063e9:	e9 29 fa ff ff       	jmp    80105e17 <alltraps>
...
801063f0:	6a 1f                	push   $0x1f
  jmp alltraps
801063f2:	e9 20 fa ff ff       	jmp    80105e17 <alltraps>
...
801063f9:	6a 20                	push   $0x20
  jmp alltraps
801063fb:	e9 17 fa ff ff       	jmp    80105e17 <alltraps>
...
80106402:	6a 21                	push   $0x21
  jmp alltraps
80106404:	e9 0e fa ff ff       	jmp    80105e17 <alltraps>
...
8010640b:	6a 22                	push   $0x22
  jmp alltraps
8010640d:	e9 05 fa ff ff       	jmp    80105e17 <alltraps>
...
80106414:	6a 23                	push   $0x23
  jmp alltraps
80106416:	e9 fc f9 ff ff       	jmp    80105e17 <alltraps>
...
8010641d:	6a 24                	push   $0x24
  jmp alltraps
8010641f:	e9 f3 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106426:	6a 25                	push   $0x25
  jmp alltraps
80106428:	e9 ea f9 ff ff       	jmp    80105e17 <alltraps>
...
8010642f:	6a 26                	push   $0x26
  jmp alltraps
80106431:	e9 e1 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106438:	6a 27                	push   $0x27
  jmp alltraps
8010643a:	e9 d8 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106441:	6a 28                	push   $0x28
  jmp alltraps
80106443:	e9 cf f9 ff ff       	jmp    80105e17 <alltraps>
...
8010644a:	6a 29                	push   $0x29
  jmp alltraps
8010644c:	e9 c6 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106453:	6a 2a                	push   $0x2a
  jmp alltraps
80106455:	e9 bd f9 ff ff       	jmp    80105e17 <alltraps>
...
8010645c:	6a 2b                	push   $0x2b
  jmp alltraps
8010645e:	e9 b4 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106465:	6a 2c                	push   $0x2c
  jmp alltraps
80106467:	e9 ab f9 ff ff       	jmp    80105e17 <alltraps>
...
8010646e:	6a 2d                	push   $0x2d
  jmp alltraps
80106470:	e9 a2 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106477:	6a 2e                	push   $0x2e
  jmp alltraps
80106479:	e9 99 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106480:	6a 2f                	push   $0x2f
  jmp alltraps
80106482:	e9 90 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106489:	6a 30                	push   $0x30
  jmp alltraps
8010648b:	e9 87 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106492:	6a 31                	push   $0x31
  jmp alltraps
80106494:	e9 7e f9 ff ff       	jmp    80105e17 <alltraps>
...
8010649b:	6a 32                	push   $0x32
  jmp alltraps
8010649d:	e9 75 f9 ff ff       	jmp    80105e17 <alltraps>
...
801064a4:	6a 33                	push   $0x33
  jmp alltraps
801064a6:	e9 6c f9 ff ff       	jmp    80105e17 <alltraps>
...
801064ad:	6a 34                	push   $0x34
  jmp alltraps
801064af:	e9 63 f9 ff ff       	jmp    80105e17 <alltraps>
...
801064b6:	6a 35                	push   $0x35
  jmp alltraps
801064b8:	e9 5a f9 ff ff       	jmp    80105e17 <alltraps>
...
801064bf:	6a 36                	push   $0x36
  jmp alltraps
801064c1:	e9 51 f9 ff ff       	jmp    80105e17 <alltraps>
...
801064c8:	6a 37                	push   $0x37
  jmp alltraps
801064ca:	e9 48 f9 ff ff       	jmp    80105e17 <alltraps>
...
801064d1:	6a 38                	push   $0x38
  jmp alltraps
801064d3:	e9 3f f9 ff ff       	jmp    80105e17 <alltraps>
...
801064da:	6a 39                	push   $0x39
  jmp alltraps
801064dc:	e9 36 f9 ff ff       	jmp    80105e17 <alltraps>
...
801064e3:	6a 3a                	push   $0x3a
  jmp alltraps
801064e5:	e9 2d f9 ff ff       	jmp    80105e17 <alltraps>
...
801064ec:	6a 3b                	push   $0x3b
  jmp alltraps
801064ee:	e9 24 f9 ff ff       	jmp    80105e17 <alltraps>
...
801064f5:	6a 3c                	push   $0x3c
  jmp alltraps
801064f7:	e9 1b f9 ff ff       	jmp    80105e17 <alltraps>
...
801064fe:	6a 3d                	push   $0x3d
  jmp alltraps
80106500:	e9 12 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106507:	6a 3e                	push   $0x3e
  jmp alltraps
80106509:	e9 09 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106510:	6a 3f                	push   $0x3f
  jmp alltraps
80106512:	e9 00 f9 ff ff       	jmp    80105e17 <alltraps>
...
80106519:	6a 40                	push   $0x40
  jmp alltraps
8010651b:	e9 f7 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106522:	6a 41                	push   $0x41
  jmp alltraps
80106524:	e9 ee f8 ff ff       	jmp    80105e17 <alltraps>
...
8010652b:	6a 42                	push   $0x42
  jmp alltraps
8010652d:	e9 e5 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106534:	6a 43                	push   $0x43
  jmp alltraps
80106536:	e9 dc f8 ff ff       	jmp    80105e17 <alltraps>
...
8010653d:	6a 44                	push   $0x44
  jmp alltraps
8010653f:	e9 d3 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106546:	6a 45                	push   $0x45
  jmp alltraps
80106548:	e9 ca f8 ff ff       	jmp    80105e17 <alltraps>
...
8010654f:	6a 46                	push   $0x46
  jmp alltraps
80106551:	e9 c1 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106558:	6a 47                	push   $0x47
  jmp alltraps
8010655a:	e9 b8 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106561:	6a 48                	push   $0x48
  jmp alltraps
80106563:	e9 af f8 ff ff       	jmp    80105e17 <alltraps>
...
8010656a:	6a 49                	push   $0x49
  jmp alltraps
8010656c:	e9 a6 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106573:	6a 4a                	push   $0x4a
  jmp alltraps
80106575:	e9 9d f8 ff ff       	jmp    80105e17 <alltraps>
...
8010657c:	6a 4b                	push   $0x4b
  jmp alltraps
8010657e:	e9 94 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106585:	6a 4c                	push   $0x4c
  jmp alltraps
80106587:	e9 8b f8 ff ff       	jmp    80105e17 <alltraps>
...
8010658e:	6a 4d                	push   $0x4d
  jmp alltraps
80106590:	e9 82 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106597:	6a 4e                	push   $0x4e
  jmp alltraps
80106599:	e9 79 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065a0:	6a 4f                	push   $0x4f
  jmp alltraps
801065a2:	e9 70 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065a9:	6a 50                	push   $0x50
  jmp alltraps
801065ab:	e9 67 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065b2:	6a 51                	push   $0x51
  jmp alltraps
801065b4:	e9 5e f8 ff ff       	jmp    80105e17 <alltraps>
...
801065bb:	6a 52                	push   $0x52
  jmp alltraps
801065bd:	e9 55 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065c4:	6a 53                	push   $0x53
  jmp alltraps
801065c6:	e9 4c f8 ff ff       	jmp    80105e17 <alltraps>
...
801065cd:	6a 54                	push   $0x54
  jmp alltraps
801065cf:	e9 43 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065d6:	6a 55                	push   $0x55
  jmp alltraps
801065d8:	e9 3a f8 ff ff       	jmp    80105e17 <alltraps>
...
801065df:	6a 56                	push   $0x56
  jmp alltraps
801065e1:	e9 31 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065e8:	6a 57                	push   $0x57
  jmp alltraps
801065ea:	e9 28 f8 ff ff       	jmp    80105e17 <alltraps>
...
801065f1:	6a 58                	push   $0x58
  jmp alltraps
801065f3:	e9 1f f8 ff ff       	jmp    80105e17 <alltraps>
...
801065fa:	6a 59                	push   $0x59
  jmp alltraps
801065fc:	e9 16 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106603:	6a 5a                	push   $0x5a
  jmp alltraps
80106605:	e9 0d f8 ff ff       	jmp    80105e17 <alltraps>
...
8010660c:	6a 5b                	push   $0x5b
  jmp alltraps
8010660e:	e9 04 f8 ff ff       	jmp    80105e17 <alltraps>
...
80106615:	6a 5c                	push   $0x5c
  jmp alltraps
80106617:	e9 fb f7 ff ff       	jmp    80105e17 <alltraps>
...
8010661e:	6a 5d                	push   $0x5d
  jmp alltraps
80106620:	e9 f2 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106627:	6a 5e                	push   $0x5e
  jmp alltraps
80106629:	e9 e9 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106630:	6a 5f                	push   $0x5f
  jmp alltraps
80106632:	e9 e0 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106639:	6a 60                	push   $0x60
  jmp alltraps
8010663b:	e9 d7 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106642:	6a 61                	push   $0x61
  jmp alltraps
80106644:	e9 ce f7 ff ff       	jmp    80105e17 <alltraps>
...
8010664b:	6a 62                	push   $0x62
  jmp alltraps
8010664d:	e9 c5 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106654:	6a 63                	push   $0x63
  jmp alltraps
80106656:	e9 bc f7 ff ff       	jmp    80105e17 <alltraps>
...
8010665d:	6a 64                	push   $0x64
  jmp alltraps
8010665f:	e9 b3 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106666:	6a 65                	push   $0x65
  jmp alltraps
80106668:	e9 aa f7 ff ff       	jmp    80105e17 <alltraps>
...
8010666f:	6a 66                	push   $0x66
  jmp alltraps
80106671:	e9 a1 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106678:	6a 67                	push   $0x67
  jmp alltraps
8010667a:	e9 98 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106681:	6a 68                	push   $0x68
  jmp alltraps
80106683:	e9 8f f7 ff ff       	jmp    80105e17 <alltraps>
...
8010668a:	6a 69                	push   $0x69
  jmp alltraps
8010668c:	e9 86 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106693:	6a 6a                	push   $0x6a
  jmp alltraps
80106695:	e9 7d f7 ff ff       	jmp    80105e17 <alltraps>
...
8010669c:	6a 6b                	push   $0x6b
  jmp alltraps
8010669e:	e9 74 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066a5:	6a 6c                	push   $0x6c
  jmp alltraps
801066a7:	e9 6b f7 ff ff       	jmp    80105e17 <alltraps>
...
801066ae:	6a 6d                	push   $0x6d
  jmp alltraps
801066b0:	e9 62 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066b7:	6a 6e                	push   $0x6e
  jmp alltraps
801066b9:	e9 59 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066c0:	6a 6f                	push   $0x6f
  jmp alltraps
801066c2:	e9 50 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066c9:	6a 70                	push   $0x70
  jmp alltraps
801066cb:	e9 47 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066d2:	6a 71                	push   $0x71
  jmp alltraps
801066d4:	e9 3e f7 ff ff       	jmp    80105e17 <alltraps>
...
801066db:	6a 72                	push   $0x72
  jmp alltraps
801066dd:	e9 35 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066e4:	6a 73                	push   $0x73
  jmp alltraps
801066e6:	e9 2c f7 ff ff       	jmp    80105e17 <alltraps>
...
801066ed:	6a 74                	push   $0x74
  jmp alltraps
801066ef:	e9 23 f7 ff ff       	jmp    80105e17 <alltraps>
...
801066f6:	6a 75                	push   $0x75
  jmp alltraps
801066f8:	e9 1a f7 ff ff       	jmp    80105e17 <alltraps>
...
801066ff:	6a 76                	push   $0x76
  jmp alltraps
80106701:	e9 11 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106708:	6a 77                	push   $0x77
  jmp alltraps
8010670a:	e9 08 f7 ff ff       	jmp    80105e17 <alltraps>
...
80106711:	6a 78                	push   $0x78
  jmp alltraps
80106713:	e9 ff f6 ff ff       	jmp    80105e17 <alltraps>
...
8010671a:	6a 79                	push   $0x79
  jmp alltraps
8010671c:	e9 f6 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106723:	6a 7a                	push   $0x7a
  jmp alltraps
80106725:	e9 ed f6 ff ff       	jmp    80105e17 <alltraps>
...
8010672c:	6a 7b                	push   $0x7b
  jmp alltraps
8010672e:	e9 e4 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106735:	6a 7c                	push   $0x7c
  jmp alltraps
80106737:	e9 db f6 ff ff       	jmp    80105e17 <alltraps>
...
8010673e:	6a 7d                	push   $0x7d
  jmp alltraps
80106740:	e9 d2 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106747:	6a 7e                	push   $0x7e
  jmp alltraps
80106749:	e9 c9 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106750:	6a 7f                	push   $0x7f
  jmp alltraps
80106752:	e9 c0 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106759:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010675e:	e9 b4 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106765:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010676a:	e9 a8 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106771:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106776:	e9 9c f6 ff ff       	jmp    80105e17 <alltraps>
...
8010677d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106782:	e9 90 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106789:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010678e:	e9 84 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106795:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010679a:	e9 78 f6 ff ff       	jmp    80105e17 <alltraps>
...
801067a1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801067a6:	e9 6c f6 ff ff       	jmp    80105e17 <alltraps>
...
801067ad:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801067b2:	e9 60 f6 ff ff       	jmp    80105e17 <alltraps>
...
801067b9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801067be:	e9 54 f6 ff ff       	jmp    80105e17 <alltraps>
...
801067c5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801067ca:	e9 48 f6 ff ff       	jmp    80105e17 <alltraps>
...
801067d1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801067d6:	e9 3c f6 ff ff       	jmp    80105e17 <alltraps>
...
801067dd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801067e2:	e9 30 f6 ff ff       	jmp    80105e17 <alltraps>
...
801067e9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801067ee:	e9 24 f6 ff ff       	jmp    80105e17 <alltraps>
...
801067f5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801067fa:	e9 18 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106801:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106806:	e9 0c f6 ff ff       	jmp    80105e17 <alltraps>
...
8010680d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106812:	e9 00 f6 ff ff       	jmp    80105e17 <alltraps>
...
80106819:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010681e:	e9 f4 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106825:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010682a:	e9 e8 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106831:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106836:	e9 dc f5 ff ff       	jmp    80105e17 <alltraps>
...
8010683d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106842:	e9 d0 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106849:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010684e:	e9 c4 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106855:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010685a:	e9 b8 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106861:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106866:	e9 ac f5 ff ff       	jmp    80105e17 <alltraps>
...
8010686d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106872:	e9 a0 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106879:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010687e:	e9 94 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106885:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010688a:	e9 88 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106891:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106896:	e9 7c f5 ff ff       	jmp    80105e17 <alltraps>
...
8010689d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801068a2:	e9 70 f5 ff ff       	jmp    80105e17 <alltraps>
...
801068a9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801068ae:	e9 64 f5 ff ff       	jmp    80105e17 <alltraps>
...
801068b5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801068ba:	e9 58 f5 ff ff       	jmp    80105e17 <alltraps>
...
801068c1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801068c6:	e9 4c f5 ff ff       	jmp    80105e17 <alltraps>
...
801068cd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801068d2:	e9 40 f5 ff ff       	jmp    80105e17 <alltraps>
...
801068d9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801068de:	e9 34 f5 ff ff       	jmp    80105e17 <alltraps>
...
801068e5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801068ea:	e9 28 f5 ff ff       	jmp    80105e17 <alltraps>
...
801068f1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801068f6:	e9 1c f5 ff ff       	jmp    80105e17 <alltraps>
...
801068fd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106902:	e9 10 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106909:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010690e:	e9 04 f5 ff ff       	jmp    80105e17 <alltraps>
...
80106915:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010691a:	e9 f8 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106921:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106926:	e9 ec f4 ff ff       	jmp    80105e17 <alltraps>
...
8010692d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106932:	e9 e0 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106939:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010693e:	e9 d4 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106945:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010694a:	e9 c8 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106951:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106956:	e9 bc f4 ff ff       	jmp    80105e17 <alltraps>
...
8010695d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106962:	e9 b0 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106969:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010696e:	e9 a4 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106975:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010697a:	e9 98 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106981:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106986:	e9 8c f4 ff ff       	jmp    80105e17 <alltraps>
...
8010698d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106992:	e9 80 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106999:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010699e:	e9 74 f4 ff ff       	jmp    80105e17 <alltraps>
...
801069a5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801069aa:	e9 68 f4 ff ff       	jmp    80105e17 <alltraps>
...
801069b1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801069b6:	e9 5c f4 ff ff       	jmp    80105e17 <alltraps>
...
801069bd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801069c2:	e9 50 f4 ff ff       	jmp    80105e17 <alltraps>
...
801069c9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801069ce:	e9 44 f4 ff ff       	jmp    80105e17 <alltraps>
...
801069d5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801069da:	e9 38 f4 ff ff       	jmp    80105e17 <alltraps>
...
801069e1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801069e6:	e9 2c f4 ff ff       	jmp    80105e17 <alltraps>
...
801069ed:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801069f2:	e9 20 f4 ff ff       	jmp    80105e17 <alltraps>
...
801069f9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801069fe:	e9 14 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106a05:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106a0a:	e9 08 f4 ff ff       	jmp    80105e17 <alltraps>
...
80106a11:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106a16:	e9 fc f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a1d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106a22:	e9 f0 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a29:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106a2e:	e9 e4 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a35:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106a3a:	e9 d8 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a41:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106a46:	e9 cc f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a4d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106a52:	e9 c0 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a59:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106a5e:	e9 b4 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a65:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106a6a:	e9 a8 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a71:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106a76:	e9 9c f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a7d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106a82:	e9 90 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a89:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106a8e:	e9 84 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106a95:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106a9a:	e9 78 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106aa1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106aa6:	e9 6c f3 ff ff       	jmp    80105e17 <alltraps>
...
80106aad:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106ab2:	e9 60 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106ab9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106abe:	e9 54 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106ac5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106aca:	e9 48 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106ad1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106ad6:	e9 3c f3 ff ff       	jmp    80105e17 <alltraps>
...
80106add:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106ae2:	e9 30 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106ae9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106aee:	e9 24 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106af5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106afa:	e9 18 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106b01:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106b06:	e9 0c f3 ff ff       	jmp    80105e17 <alltraps>
...
80106b0d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106b12:	e9 00 f3 ff ff       	jmp    80105e17 <alltraps>
...
80106b19:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106b1e:	e9 f4 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b25:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106b2a:	e9 e8 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b31:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106b36:	e9 dc f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b3d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106b42:	e9 d0 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b49:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106b4e:	e9 c4 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b55:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106b5a:	e9 b8 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b61:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106b66:	e9 ac f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b6d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106b72:	e9 a0 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b79:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106b7e:	e9 94 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b85:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106b8a:	e9 88 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b91:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106b96:	e9 7c f2 ff ff       	jmp    80105e17 <alltraps>
...
80106b9d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106ba2:	e9 70 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106ba9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106bae:	e9 64 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106bb5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106bba:	e9 58 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106bc1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106bc6:	e9 4c f2 ff ff       	jmp    80105e17 <alltraps>
...
80106bcd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106bd2:	e9 40 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106bd9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106bde:	e9 34 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106be5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106bea:	e9 28 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106bf1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106bf6:	e9 1c f2 ff ff       	jmp    80105e17 <alltraps>
...
80106bfd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106c02:	e9 10 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106c09:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106c0e:	e9 04 f2 ff ff       	jmp    80105e17 <alltraps>
...
80106c15:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106c1a:	e9 f8 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c21:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106c26:	e9 ec f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c2d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106c32:	e9 e0 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c39:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106c3e:	e9 d4 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c45:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106c4a:	e9 c8 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c51:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106c56:	e9 bc f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c5d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106c62:	e9 b0 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c69:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106c6e:	e9 a4 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c75:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106c7a:	e9 98 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c81:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106c86:	e9 8c f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c8d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106c92:	e9 80 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106c99:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106c9e:	e9 74 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106ca5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106caa:	e9 68 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106cb1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106cb6:	e9 5c f1 ff ff       	jmp    80105e17 <alltraps>
...
80106cbd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106cc2:	e9 50 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106cc9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106cce:	e9 44 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106cd5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106cda:	e9 38 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106ce1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106ce6:	e9 2c f1 ff ff       	jmp    80105e17 <alltraps>
...
80106ced:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106cf2:	e9 20 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106cf9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106cfe:	e9 14 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106d05:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106d0a:	e9 08 f1 ff ff       	jmp    80105e17 <alltraps>
...
80106d11:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106d16:	e9 fc f0 ff ff       	jmp    80105e17 <alltraps>
...
80106d1d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106d22:	e9 f0 f0 ff ff       	jmp    80105e17 <alltraps>
...
80106d29:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106d2e:	e9 e4 f0 ff ff       	jmp    80105e17 <alltraps>
...
80106d35:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106d3a:	e9 d8 f0 ff ff       	jmp    80105e17 <alltraps>
...
80106d41:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106d46:	e9 cc f0 ff ff       	jmp    80105e17 <alltraps>
...
80106d4d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106d52:	e9 c0 f0 ff ff       	jmp    80105e17 <alltraps>
...
80106de9:	e8 d2 b6 ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
80106dff:	68 c6 79 10 80       	push   $0x801079c6
...
80106e8e:	e8 ed b7 ff ff       	call   80102680 <kalloc>
...
80106ea5:	e8 b6 dc ff ff       	call   80104b60 <memset>
...
80106eed:	68 54 80 10 80       	push   $0x80108054
...
80106f03:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106f06:	e8 65 cb ff ff       	call   80103a70 <cpuid>
  pd[0] = size-1;
...
80106f1a:	c7 80 38 28 11 80 ff 	movl   $0xffff,-0x7feed7c8(%eax)
80106f21:	ff 00 00 
80106f24:	c7 80 3c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7c4(%eax)
80106f2b:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106f2e:	c7 80 40 28 11 80 ff 	movl   $0xffff,-0x7feed7c0(%eax)
80106f35:	ff 00 00 
80106f38:	c7 80 44 28 11 80 00 	movl   $0xcf9200,-0x7feed7bc(%eax)
80106f3f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106f42:	c7 80 48 28 11 80 ff 	movl   $0xffff,-0x7feed7b8(%eax)
80106f49:	ff 00 00 
80106f4c:	c7 80 4c 28 11 80 00 	movl   $0xcffa00,-0x7feed7b4(%eax)
80106f53:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106f56:	c7 80 50 28 11 80 ff 	movl   $0xffff,-0x7feed7b0(%eax)
80106f5d:	ff 00 00 
80106f60:	c7 80 54 28 11 80 00 	movl   $0xcff200,-0x7feed7ac(%eax)
80106f67:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106f6a:	05 30 28 11 80       	add    $0x80112830,%eax
  pd[1] = (uint)p;
...
80106f90:	a1 e4 62 11 80       	mov    0x801162e4,%eax
...
80106fcf:	e8 3c ca ff ff       	call   80103a10 <mycpu>
80106fd4:	89 c3                	mov    %eax,%ebx
80106fd6:	e8 35 ca ff ff       	call   80103a10 <mycpu>
80106fdb:	89 c7                	mov    %eax,%edi
80106fdd:	e8 2e ca ff ff       	call   80103a10 <mycpu>
80106fe2:	83 c7 08             	add    $0x8,%edi
80106fe5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106fe8:	e8 23 ca ff ff       	call   80103a10 <mycpu>
...
80107079:	5d                   	pop    %ebp
  popcli();
8010707a:	e9 21 d9 ff ff       	jmp    801049a0 <popcli>
...
801070cb:	77 4b                	ja     80107118 <inituvm+0x68>
  mem = kalloc();
801070cd:	e8 ae b5 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
801070df:	e8 7c da ff ff       	call   80104b60 <memset>
...
80107112:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80107113:	e9 e8 da ff ff       	jmp    80104c00 <memmove>
    panic("inituvm: more than a page");
80107118:	83 ec 0c             	sub    $0xc,%esp
8010711b:	68 99 80 10 80       	push   $0x80108099
...
80107180:	68 b3 80 10 80       	push   $0x801080b3
...
801071ce:	e8 bd a8 ff ff       	call   80101a90 <readi>
...
80107208:	68 54 81 10 80       	push   $0x80108154
...
80107299:	76 48                	jbe    801072e3 <allocuvm+0xc3>
    mem = kalloc();
8010729b:	e8 e0 b3 ff ff       	call   80102680 <kalloc>
...
801072a9:	68 d1 80 10 80       	push   $0x801080d1
...
8010730b:	68 e9 80 10 80       	push   $0x801080e9
...
80107330:	e8 8b b1 ff ff       	call   801024c0 <kfree>
      return 0;
...
801073ec:	68 05 81 10 80       	push   $0x80108105
...
80107413:	bb 40 b4 10 80       	mov    $0x8010b440,%ebx
  memset(pgdir, 0, PGSIZE);
...
8010744a:	81 fb 80 b4 10 80    	cmp    $0x8010b480,%ebx
...
8010748b:	a3 e4 62 11 80       	mov    %eax,0x801162e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801074bc:	68 16 81 10 80       	push   $0x80108116
...
80107532:	68 20 81 10 80       	push   $0x80108120
...
80107607:	68 3a 81 10 80       	push   $0x8010813a
