   ...
   f:	31 db                	xor    %ebx,%ebx
{
  ...
  15:	8d 76 00             	lea    0x0(%esi),%esi
    {
        int pid = fork();
  18:	e8 ee 02 00 00       	call   30b <fork>
        if (pid < 0)
  1d:	85 c0                	test   %eax,%eax
  1f:	78 1e                	js     3f <main+0x3f>
        {
        ...
        if (pid == 0)
  21:	74 2f                	je     52 <main+0x52>
    for (int i = 0; i < num_processes; i++)
  23:	83 c3 01             	add    $0x1,%ebx
  26:	83 fb 0a             	cmp    $0xa,%ebx
  ...
  38:	75 f6                	jne    30 <main+0x30>
            exit();
  3a:	e8 d4 02 00 00       	call   313 <exit>
            printf(1, "Fork failed for process %d\n", i);
  3f:	56                   	push   %esi
  40:	53                   	push   %ebx
  41:	68 a8 07 00 00       	push   $0x7a8
  46:	6a 01                	push   $0x1
  48:	e8 33 04 00 00       	call   480 <printf>
            exit();
  4d:	e8 c1 02 00 00       	call   313 <exit>
  ...
  5c:	29 de                	sub    %ebx,%esi
            if (set_priority(priority, getpid()) < 0)
  5e:	51                   	push   %ecx
  5f:	51                   	push   %ecx
  60:	50                   	push   %eax
  61:	56                   	push   %esi
  62:	e8 5c 03 00 00       	call   3c3 <set_priority>
  67:	83 c4 10             	add    $0x10,%esp
  6a:	85 c0                	test   %eax,%eax
  6c:	78 34                	js     a2 <main+0xa2>
  ...
  7f:	d9 ee                	fldz   
  81:	dd 05 10 08 00 00    	fldl   0x810
  87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8e:	66 90                	xchg   %ax,%ax
  90:	dc c1                	fadd   %st,%st(1)
  92:	d9 05 18 08 00 00    	flds   0x818
  98:	df f2                	fcomip %st(2),%st
  9a:	77 f4                	ja     90 <main+0x90>
  9c:	dd d8                	fstp   %st(0)
  9e:	dd d8                	fstp   %st(0)
  a0:	eb 98                	jmp    3a <main+0x3a>
                printf(1, "Failed to set priority for process %d\n", i);
  a2:	52                   	push   %edx
  a3:	53                   	push   %ebx
  a4:	68 e4 07 00 00       	push   $0x7e4
  a9:	6a 01                	push   $0x1
 ...
 1e9:	31 db                	xor    %ebx,%ebx
{
 ...
 1f5:	57                   	push   %edi
 1f6:	6a 00                	push   $0x0
 1f8:	e8 3e 01 00 00       	call   33b <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 25d:	e8 01 01 00 00       	call   363 <open>
  if(fd < 0)
 ...
 271:	50                   	push   %eax
 272:	e8 04 01 00 00       	call   37b <fstat>
  close(fd);
 277:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 27a:	89 c6                	mov    %eax,%esi
  close(fd);
 27c:	e8 ca 00 00 00       	call   34b <close>
  return r;
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 7c 08 00 00 	movzbl 0x87c(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 24 08 00 00 	jmp    *0x824(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 1c 08 00 00       	mov    $0x81c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
 ...
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 30 0b 00 00       	mov    $0xb30,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 792:	00 00 00 
    if(p->s.size >= nunits){
