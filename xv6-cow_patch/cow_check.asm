...
_cow_check:     file format elf32-i386
...
int main(void) {
  ...
  14:	e8 ea 03 00 00       	call   403 <getfreepages>
  ...
  1d:	89 c6                	mov    %eax,%esi
    printf(1, "Parent: Initial number of free pages: %d\n", numInitialFreePageParent);
  1f:	68 e8 07 00 00       	push   $0x7e8
  24:	6a 01                	push   $0x1
  26:	e8 95 04 00 00       	call   4c0 <printf>
  ...
  2e:	31 c0                	xor    %eax,%eax
        shared_array[i] = i;
  30:	89 04 85 80 0c 00 00 	mov    %eax,0xc80(,%eax,4)
    for (int i = 0; i < ARRAY_SIZE; i++) {
  37:	83 c0 01             	add    $0x1,%eax
  3a:	3d 00 90 01 00       	cmp    $0x19000,%eax
  3f:	75 ef                	jne    30 <main+0x30>
    }

    for (int i = 0; i < 2; i++) {
        pid = fork();
  41:	e8 15 03 00 00       	call   35b <fork>
  46:	89 c3                	mov    %eax,%ebx
        if (pid == 0) {
  48:	85 c0                	test   %eax,%eax
  4a:	74 46                	je     92 <main+0x92>
            ...
            wait();
  4c:	e8 1a 03 00 00       	call   36b <wait>
        pid = fork();
  51:	e8 05 03 00 00       	call   35b <fork>
        if (pid == 0) {
  56:	85 c0                	test   %eax,%eax
  58:	74 33                	je     8d <main+0x8d>
            wait();
  5a:	e8 0c 03 00 00       	call   36b <wait>
        }
    }

    int numFinalFreePageParent = getfreepages();
  5f:	e8 9f 03 00 00       	call   403 <getfreepages>
  ...
  7b:	53                   	push   %ebx
  7c:	68 54 08 00 00       	push   $0x854
  81:	6a 01                	push   $0x1
  83:	e8 38 04 00 00       	call   4c0 <printf>

    exit();
  88:	e8 d6 02 00 00       	call   363 <exit>
    for (int i = 0; i < 2; i++) {
  8d:	bb 01 00 00 00       	mov    $0x1,%ebx
            int numInitialFreePageChild = getfreepages(); // Free pages count before modifying shared memory
  92:	e8 6c 03 00 00       	call   403 <getfreepages>
  ...
  ca:	29 fe                	sub    %edi,%esi
            printf(1, "Child %d: Final free pages after write: %d\n", i, numFinalFreePageChild);
  cc:	68 d0 08 00 00       	push   $0x8d0
  d1:	6a 01                	push   $0x1
  d3:	e8 e8 03 00 00       	call   4c0 <printf>
            if (pagesAllocated > 0) {
  d8:	83 c4 10             	add    $0x10,%esp
  db:	85 f6                	test   %esi,%esi
  dd:	7e 16                	jle    f5 <main+0xf5>
                printf(1, "Child %d: Number of pages allocated due to COW: %d\n", i, pagesAllocated);
  df:	56                   	push   %esi
  e0:	53                   	push   %ebx
  e1:	68 fc 08 00 00       	push   $0x8fc
  e6:	6a 01                	push   $0x1
  e8:	e8 d3 03 00 00       	call   4c0 <printf>
  ed:	83 c4 10             	add    $0x10,%esp
            exit();
  f0:	e8 6e 02 00 00       	call   363 <exit>
                printf(1, "Child %d: Error: No decrease in number of free pages\n", i);
  f5:	50                   	push   %eax
  f6:	53                   	push   %ebx
  f7:	68 30 09 00 00       	push   $0x930
  fc:	6a 01                	push   $0x1
  fe:	e8 bd 03 00 00       	call   4c0 <printf>
 103:	83 c4 10             	add    $0x10,%esp
 106:	eb e8                	jmp    f0 <main+0xf0>
...
00000410 <printint>:
 ...
 449:	0f b6 92 c8 09 00 00 	movzbl 0x9c8(%edx),%edx
...
000004c0 <printf>:
 ...
 539:	ff 24 85 70 09 00 00 	jmp    *0x970(,%eax,4)
 ...
 647:	90                   	nop
 648:	ba 66 09 00 00       	mov    $0x966,%edx
...
00000660 <free>:
 660:	55                   	push   %ebp
 661:	a1 80 4c 06 00       	mov    0x64c80,%eax
 ...
 6a1:	5b                   	pop    %ebx
 6a2:	89 15 80 4c 06 00    	mov    %edx,0x64c80
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 6ab:	c3                   	ret    
 ...
 6dc:	89 15 80 4c 06 00    	mov    %edx,0x64c80
...
000006f0 <malloc>:
 ...
 6fc:	8b 3d 80 4c 06 00    	mov    0x64c80,%edi
 ...
 741:	8b 3d 80 4c 06 00    	mov    0x64c80,%edi
 ...
 76f:	8b 15 80 4c 06 00    	mov    0x64c80,%edx
 ...
 79f:	89 15 80 4c 06 00    	mov    %edx,0x64c80
 ...
 7ae:	5d                   	pop    %ebp
 7af:	c3                   	ret    
 7b0:	c7 05 80 4c 06 00 84 	movl   $0x64c84,0x64c80
 7b7:	4c 06 00 
 7ba:	bf 84 4c 06 00       	mov    $0x64c84,%edi
 7bf:	c7 05 84 4c 06 00 84 	movl   $0x64c84,0x64c84
 7c6:	4c 06 00 
 7c9:	89 fa                	mov    %edi,%edx
 7cb:	c7 05 88 4c 06 00 00 	movl   $0x0,0x64c88
 7d2:	00 00 00 
