...
main(int argc, char *argv[])
{
  ...
  55:	e8 a1 05 00 00       	call   5fb <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 a5 05 00 00       	call   613 <open>
...
000001d0 <grep>:
{
 ...
 208:	e8 de 03 00 00       	call   5eb <read>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 62 03 00 00       	call   5f3 <write>
 ...
 499:	31 db                	xor    %ebx,%ebx
{
 ...
 4a5:	57                   	push   %edi
 4a6:	6a 00                	push   $0x0
 4a8:	e8 3e 01 00 00       	call   5eb <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 50d:	e8 01 01 00 00       	call   613 <open>
  if(fd < 0)
 ...
 521:	50                   	push   %eax
 522:	e8 04 01 00 00       	call   62b <fstat>
  close(fd);
 527:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 52a:	89 c6                	mov    %eax,%esi
  close(fd);
 52c:	e8 ca 00 00 00       	call   5fb <close>
  return r;
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 775:	57                   	push   %edi
 776:	56                   	push   %esi
 777:	e8 77 fe ff ff       	call   5f3 <write>
 ...
 7ce:	e8 20 fe ff ff       	call   5f3 <write>
        putc(fd, c);
 ...
 7df:	57                   	push   %edi
 7e0:	56                   	push   %esi
 7e1:	e8 0d fe ff ff       	call   5f3 <write>
        putc(fd, c);
 ...
 88c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 88f:	e8 5f fd ff ff       	call   5f3 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9c3:	e8 93 fc ff ff       	call   65b <sbrk>
  if(p == (char*)-1)
