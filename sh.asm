...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 24 0c 00 00       	call   e43 <pipe>
    ...
    close(rcmd->fd);
     ...
     286:	e8 d0 0b 00 00       	call   e5b <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 db 0b 00 00       	call   e73 <open>
    ...
    panic("runcmd");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 78 0b 00 00       	call   e5b <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 bf 0b 00 00       	call   eab <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 66 0b 00 00       	call   e5b <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 5d 0b 00 00       	call   e5b <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 4a 0b 00 00       	call   e5b <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 91 0b 00 00       	call   eab <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 38 0b 00 00       	call   e5b <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 2f 0b 00 00       	call   e5b <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
