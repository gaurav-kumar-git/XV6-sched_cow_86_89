...
00000010 <printf>:
{
  ...
  28:	e8 76 03 00 00       	call   3a3 <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  5c:	6a 01                	push   $0x1
  5e:	e8 40 03 00 00       	call   3a3 <write>
  ...
  be:	6a 01                	push   $0x1
  c0:	e8 de 02 00 00       	call   3a3 <write>
}
  ...
  e5:	6a 01                	push   $0x1
  e7:	e8 b7 02 00 00       	call   3a3 <write>
      exit();
 ...
 249:	31 db                	xor    %ebx,%ebx
{
 ...
 255:	57                   	push   %edi
 256:	6a 00                	push   $0x0
 258:	e8 3e 01 00 00       	call   39b <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2bd:	e8 01 01 00 00       	call   3c3 <open>
  if(fd < 0)
 ...
 2d1:	50                   	push   %eax
 2d2:	e8 04 01 00 00       	call   3db <fstat>
  close(fd);
 2d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2da:	89 c6                	mov    %eax,%esi
  close(fd);
 2dc:	e8 ca 00 00 00       	call   3ab <close>
  return r;
