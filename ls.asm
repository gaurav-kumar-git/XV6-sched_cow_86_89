...
00000100 <ls>:
{
 ...
 155:	53                   	push   %ebx
 156:	e8 70 04 00 00       	call   5cb <close>
...
stat(const char *n, struct stat *st)
{
 ...
 4dd:	e8 01 01 00 00       	call   5e3 <open>
  if(fd < 0)
 ...
 4f1:	50                   	push   %eax
 4f2:	e8 04 01 00 00       	call   5fb <fstat>
  close(fd);
 4f7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4fa:	89 c6                	mov    %eax,%esi
  close(fd);
 4fc:	e8 ca 00 00 00       	call   5cb <close>
  return r;
 ...
 709:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 745:	57                   	push   %edi
 746:	56                   	push   %esi
 747:	e8 77 fe ff ff       	call   5c3 <write>
 ...
 79e:	e8 20 fe ff ff       	call   5c3 <write>
        putc(fd, c);
 ...
 7af:	57                   	push   %edi
 7b0:	56                   	push   %esi
 7b1:	e8 0d fe ff ff       	call   5c3 <write>
        putc(fd, c);
 ...
 85c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 85f:	e8 5f fd ff ff       	call   5c3 <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 993:	e8 93 fc ff ff       	call   62b <sbrk>
  if(p == (char*)-1)
